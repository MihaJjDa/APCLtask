...
class MorphCollection(MorphBaseInfo):
    ...
    def _deserialize(self, stream : io.IOBase) -> None:
        from pullenti.ner.core.internal.SerializerHelper import SerializerHelper
        self.__m_class = MorphClass._new62(SerializerHelper.deserializeShort(stream))
        self.__m_case = MorphCase._new47(SerializerHelper.deserializeShort(stream))
        ...
        self.__m_language = MorphLang._new5(SerializerHelper.deserializeShort(stream))
    ...
    def __deserializeItem(self, stream : io.IOBase) -> 'MorphBaseInfo':
        ...
        res.class0_ = MorphClass._new62(SerializerHelper.deserializeShort(stream))
        res.case_ = MorphCase._new47(SerializerHelper.deserializeShort(stream))
        ...
        res.language = MorphLang._new5(SerializerHelper.deserializeShort(stream))
        if (ty == 0): 
            return res
    ...
    @staticmethod
    def _new565(_arg1 : 'MorphClass') -> 'MorphCollection':
        res = MorphCollection()
        res.class0_ = _arg1
        return res
    
    @staticmethod
    def _new2199(_arg1 : 'MorphGender') -> 'MorphCollection':
        res = MorphCollection()
        res.gender = _arg1
        return res
    
    @staticmethod
    def _new2295(_arg1 : 'MorphCase') -> 'MorphCollection':
        res = MorphCollection()
        res.case_ = _arg1
        return res
