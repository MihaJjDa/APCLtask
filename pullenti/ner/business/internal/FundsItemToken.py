...
class FundsItemToken(MetaToken):
            ...
            if (isinstance(tt, NumberToken)): 
                ...
                if (num is not None): 
                    ...
                    if (num.ex_typ == NumberExType.PERCENT): 
                        res = FundsItemToken._new434(t, num.end_token, FundsItemTyp.PERCENT, num)
                ...
                if (t1.next0_ is not None and t1.next0_.isValue("ШТУКА", None)): 
                    t1 = t1.next0_
                return FundsItemToken._new434(t, t1, FundsItemTyp.COUNT, Utils.asObjectOrNull(tt, NumberToken))
            break
        return None
    ...
    @staticmethod
    def _new434(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'FundsItemTyp', _arg4 : 'NumberToken') -> 'FundsItemToken':
        res = FundsItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.num_val = _arg4
        return res
