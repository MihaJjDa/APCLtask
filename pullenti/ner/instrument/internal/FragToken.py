...
class FragToken(MetaToken):
    ...
    def _analizeTables(self) -> bool:
        ...
        while True:
            ...
            if (t0.end_char < rows[0].begin_char): 
                self.children.append(FragToken._new1242(t0, rows[0].begin_token.previous, InstrumentKind.CONTENT))
            tab = FragToken._new1242(rows[0].begin_token, rows[len(rows) - 1].end_token, InstrumentKind.TABLE)
            self.children.append(tab)
            i = 0
            while i < len(rows): 
                rr = FragToken._new1259(rows[i].begin_token, rows[i].end_token, InstrumentKind.TABLEROW, i + 1)
                ...
                for ce in rows[i].cells: 
                    no += 1
                    cell = FragToken._new1259(ce.begin_token, ce.end_token, InstrumentKind.TABLECELL, no)
                    if (ce.col_span > 1): 
        ...
        if ((t0 is not None and (t0.end_char < self.end_char) and tabs) and t0 != self.end_token): 
            self.children.append(FragToken._new1242(t0, self.end_token, InstrumentKind.CONTENT))
        return tabs
    ...
    def __createDocTitle_(t0 : 'Token', doc : 'InstrumentReferent') -> 'FragToken':
        ...
        if (t0 is None): 
            return None
        title = FragToken._new1242(t0, t0, InstrumentKind.HEAD)
        dt0 = None
        t1 = None
        name_ = None
        nt0 = None
        ...
        if (t is not None and t.isValue("ДЕЛО", "СПРАВА")): 
            ...
            if (dt is not None and dt.typ == DecreeToken.ItemType.NUMBER): 
                dt.begin_token = t
                title.children.append(FragToken._new1293(t, t, InstrumentKind.KEYWORD, "ДЕЛО"))
        ...
        while True:
            ...
            if (t.is_newline_before or ((t.previous is not None and t.previous.is_table_control_char))): 
                ...
                if (iii is not None and iii.typ == InstrToken1.Types.COMMENT): 
                    cmt = FragToken._new1242(iii.begin_token, iii.end_token, InstrumentKind.COMMENT)
                ...
                if (iii is not None and iii.end_token.isChar('?')): 
                    cmt = FragToken._new1242(iii.begin_token, iii.end_token, InstrumentKind.NAME)
                ...
                if ((((t.isValue("ЗАЯВИТЕЛЬ", "ЗАЯВНИК") or t.isValue("ИСТЕЦ", "ПОЗИВАЧ") or t.isValue("ОТВЕТЧИК", "ВІДПОВІДАЧ")) or t.isValue("ДОЛЖНИК", "БОРЖНИК") or t.isValue("КОПИЯ", "КОПІЯ"))) and t.next0_ is not None and ((t.next0_.isChar(':') or t.next0_.is_table_control_char))): 
                    ...
                    if (ptt is not None): 
                        ...
                        if (t1.next0_ is not None and t1.next0_.isChar('(')): 
                            ...
                            if (br is not None): 
                                t1 = br.end_token
                        ft = FragToken._new1242(t, t1, InstrumentKind.INITIATOR)
                ...
                if (t.isValue("ЦЕНА", "ЦІНА") and t.next0_ is not None and t.next0_.isValue("ИСК", "ПОЗОВ")): 
                    ...
                    if (tt is not None and has_money): 
                        ...
                        if (tt.next0_ is not None and tt.next0_.isChar('(')): 
                            ...
                            if (br is not None): 
                                tt = br.end_token
                        title.children.append(FragToken._new1242(t, tt, InstrumentKind.CASEINFO))
                        t1 = tt
                        title.end_token = t1
                        t = title.end_token
                        continue
                if (t.isValue("В", "У")): 
                    ...
                    if (tt is not None and (isinstance(tt.getReferent(), OrganizationReferent))): 
                        ...
                        if (t1.next0_ is not None and t1.next0_.isChar('(')): 
                            ...
                            if (br is not None): 
                                t1 = br.end_token
                        ooo = FragToken._new1242(t, t1, InstrumentKind.ORGANIZATION)
                        ooo.referents = list()
                ...
                if (t.length_char == 1 and t.chars.is_letter and t.is_whitespace_after): 
                    ...
                    while ii < len(InstrToken._m_directives_norm): 
                        ...
                        if (ee is not None and ee.is_newline_after): 
                            ooo = FragToken._new1293(t, ee, InstrumentKind.KEYWORD, InstrToken._m_directives_norm[ii])
                            title.children.append(ooo)
            ...
            if (dr0 is not None): 
                if (doc.typ is None or doc.typ == dr0.typ): 
                    ...
                    if (li is not None and len(li) > 0 and li[len(li) - 1].is_newline_after): 
                        ...
                        if (doc.typ == "КОДЕКС"): 
                            ...
                            if (pt is not None and len(pt.values) > 0): 
                                ...
                                title.children.append(FragToken._new1293(pt.begin_token, pt.end_token, InstrumentKind.DOCPART, pt.values[0].value))
                                t = pt.end_token
                                continue
                    ...
                    t1 = t
                    title.children.append(FragToken._new1293(t, t, InstrumentKind.NAME, nam))
                    if (pt is not None and len(pt.values) > 0): 
                        title.children.append(FragToken._new1293(pt.begin_token, pt.end_token, InstrumentKind.DOCPART, pt.values[0].value))
                        t1 = pt.end_token
                    t = t1
            ...
            if (doc.typ is None): 
                ...
                if (ttt1 is not None and ttt1.is_newline_after): 
                    ...
                    if (doc.typ is None): 
                        doc.typ = typ
                    title.children.append(FragToken._new1293(t, ttt1, InstrumentKind.TYP, typ))
                    dt0 = DecreeToken._new818(t, ttt1, DecreeToken.ItemType.TYP, typ)
                    can_be_orgs = False
                    t = ttt1
                    t1 = t
                    continue
            ...
            if (dt is None and dt0 is not None and ((dt0.typ == DecreeToken.ItemType.OWNER or dt0.typ == DecreeToken.ItemType.ORG))): 
                if ((isinstance(t, NumberToken)) and t.is_newline_after and t.is_newline_before): 
                    dt = DecreeToken._new818(t, t, DecreeToken.ItemType.NUMBER, str((t).value))
            ...
            if (dt is None): 
                ...
                if (t.isValue("ДАТА", None)): 
                    ...
                    while True:
                        ...
                        if (da is not None): 
                            frdt = FragToken._new1242(t, tt, InstrumentKind.DATE)
                ...
                if (((isinstance(r, AddressReferent)) or (isinstance(r, UriReferent)) or (isinstance(r, PhoneReferent))) or (isinstance(r, PersonIdentityReferent)) or (isinstance(r, BankDataReferent))): 
                    cnt = FragToken._new1242(t, t, InstrumentKind.CONTACT)
                    cnt.referents = list()
            ...
            if (t == t0): 
                ...
                if (nam is not None): 
                    ...
                    if (not Utils.isNullOrEmpty(name_)): 
                        ...
                        title.children.append(FragToken._new1293(t0, t1, InstrumentKind.NAME, name_.strip()))
        ...
        if (end_empty_lines is not None and doc.findSlot(InstrumentReferent.ATTR_SOURCE, None, True) is None): 
            ...
            title.children.insert(0, FragToken._new1293(t0, end_empty_lines, InstrumentKind.ORGANIZATION, val))
        is_case = False
        ...
        if ((((name_ is not None or t.is_newline_before or ((t.previous is not None and t.previous.is_table_control_char))) or ((not t.is_newline_before and len(title.children) > 0 and title.children[len(title.children) - 1].kind == InstrumentKind.TYP)))) and not is_case): 
            ...
            if (val is not None): 
                ...
                title.children.append(FragToken._new1293(tt0, t1, InstrumentKind.NAME, val.strip()))
                if ("КОДЕКС" in val): 
                    npt = NounPhraseHelper.tryParse(tt0, NounPhraseParseAttr.NO, 0)
        ...
        while True:
            ...
            if (t1.is_newline_before and t1.isValue("ЧАСТЬ", "ЧАСТИНА")): 
                ...
                if (pt is not None and pt.is_newline_after): 
                    ...
                    if (pt2 is not None and (((pt2.typ == PartToken.ItemType.SECTION or pt2.typ == PartToken.ItemType.SUBSECTION or pt2.typ == PartToken.ItemType.CHAPTER) or pt2.typ == PartToken.ItemType.CLAUSE))): 
                        ...
                        doc.addSlot(InstrumentReferent.ATTR_PART, pt.values[0].value, False, 0)
                        title.children.append(FragToken._new1293(t1, pt.end_token, InstrumentKind.DOCPART, pt.values[0].value))
            ...
            if ((isinstance(t1.getReferent(), DecreeReferent)) and (t1.getReferent()).kind == DecreeKind.PUBLISHER and t1.is_newline_after): 
                pub = FragToken._new1242(t1, t1, InstrumentKind.APPROVED)
                pub.referents = list()
            ...
            if (tt.isCharOf("([") and tt.is_newline_before): 
                ...
                if (br is not None): 
                    ...
                    t1 = title.end_token
                    title.children.append(FragToken._new1242(br.begin_token, br.end_token, (InstrumentKind.NAME if tt.isChar('[') else InstrumentKind.COMMENT)))
                    continue
            break
    ...
    def __createAppendixTitle(t0 : 'Token', app : 'FragToken', doc : 'InstrumentReferent', is_app : bool, start : bool) -> 'FragToken':
        ...
        if (rr is not None): 
            if (rr.type_name == "PERSON"): 
                return None
        title = FragToken._new1242(t0, t, InstrumentKind.HEAD)
        ...
        while True:
            ...
            if (isinstance(t, TextToken)): 
                title.children.append(FragToken._new1261(t, t2, InstrumentKind.KEYWORD, True))
            t = fr.end_token
            title.end_token = t
            if (fr.typ == InstrToken1.Types.APPENDIX and fr.num_begin_token is None): 
                ...
                if (fr1 is not None and fr1.typ == InstrToken1.Types.APPROVED): 
                    t = fr1.begin_token
                    title.children.append(FragToken._new1293(t, t, InstrumentKind.KEYWORD, t.getSourceText().upper()))
                    t = fr1.end_token
                    title.end_token = t
                    fr = fr1
            if (fr.num_begin_token is not None and fr.num_end_token is not None): 
                num = FragToken._new1293(fr.num_begin_token, fr.num_end_token, InstrumentKind.NUMBER, MiscHelper.getTextValue(fr.num_begin_token, fr.num_end_token, GetTextAttr.KEEPREGISTER))
                ...
                if ((t.getReferent()).kind == DecreeKind.PUBLISHER): 
                    ff = FragToken._new1242(t, t, InstrumentKind.APPROVED)
                    ff.referents = list()
                    ...
                    appr = FragToken._new1242(kw.begin_token, t, InstrumentKind.APPROVED)
                    del title.children[len(title.children) - 1]
                    appr.children.append(kw)
                    appr.children.append(FragToken._new1242(t, t, InstrumentKind.DOCREFERENCE))
                    title.children.append(appr)
                else: 
                    title.children.append(FragToken._new1242(t, t, InstrumentKind.DOCREFERENCE))
            elif (fr.typ == InstrToken1.Types.APPROVED and fr.length_char > 15 and fr.begin_token != fr.end_token): 
                title.children.append(FragToken._new1242(fr.begin_token.next0_, t, InstrumentKind.DOCREFERENCE))
            else: 
                ...
                if (dts is not None and len(dts) > 0 and dts[0].typ == DecreeToken.ItemType.TYP): 
                    dref = FragToken._new1242(dts[0].begin_token, dts[0].end_token, InstrumentKind.DOCREFERENCE)
                    i = 1
                    while i < len(dts): 
        ...
        if (t.isValue("К", "ДО")): 
            ...
            if (max_ind >= 0): 
                ...
                te = t.next0_
            if (te is not None): 
                dr = FragToken._new1242(t, te, InstrumentKind.DOCREFERENCE)
        ...
        while True:
            ...
            if (t.is_newline_before): 
                ...
                if (ltt.typ == InstrToken1.Types.APPROVED): 
                    title.children.append(FragToken._new1242(ltt.begin_token, ltt.begin_token, InstrumentKind.APPROVED))
                    if (ltt.begin_token != ltt.end_token): 
                        title.children.append(FragToken._new1242(ltt.begin_token.next0_, ltt.end_token, InstrumentKind.DOCREFERENCE))
                    t = ltt.end_token
                ...
                if (ltt.has_verb and not ltt.all_upper): 
                    if (t.chars.is_letter and t.chars.is_all_lower): 
                        ...
                        pass
                    elif ((t == tt0 and ltt.end_token.next0_ is not None and ltt.end_token.next0_.isChar(chr(0x1E))) and not ltt.end_token.isChar(':')): 
                        pass
                    else: 
                        break
                if (ltt.typ == InstrToken1.Types.DIRECTIVE): 
    ...
    def __addTitleAttr(doc : 'InstrumentReferent', title : 'FragToken', dt : 'DecreeToken') -> bool:
        if (dt.typ == DecreeToken.ItemType.TYP): 
            ...
            if (title is not None): 
                title.children.append(FragToken._new1293(dt.begin_token, dt.end_token, InstrumentKind.TYP, Utils.ifNotNull(dt.full_value, dt.value)))
            ...
            if (dt.is_delo): 
                if (doc is not None): 
                    ...
                    if (doc.reg_number == dt.value): 
                        doc.reg_number = None
                if (title is not None): 
                    title.children.append(FragToken._new1293(dt.begin_token, dt.end_token, InstrumentKind.CASENUMBER, dt.value))
            else: 
                ...
                if (title is not None): 
                    title.children.append(FragToken._new1293(dt.begin_token, dt.end_token, InstrumentKind.NUMBER, dt.value))
            ...
            if (title is not None): 
                title.children.append(FragToken._new1293(dt.begin_token, dt.end_token, InstrumentKind.NAME, dt.value))
        elif (dt.typ == DecreeToken.ItemType.DATE): 
            if (doc is None or doc._addDate(dt)): 
                if (title is not None): 
                    title.children.append(FragToken._new1293(dt.begin_token, dt.end_token, InstrumentKind.DATE, dt))
        elif (dt.typ == DecreeToken.ItemType.TERR): 
            if (title is not None): 
                title.children.append(FragToken._new1293(dt.begin_token, dt.end_token, InstrumentKind.PLACE, dt))
            ...
            if (title is not None): 
                title.children.append(FragToken._new1293(dt.begin_token, dt.end_token, (InstrumentKind.ORGANIZATION if dt.typ == DecreeToken.ItemType.ORG else InstrumentKind.INITIATOR), dt))
            if (doc is not None): 
        ...
        while t is not None and (cou < 30): 
            ...
            if (t.isValue("ОТВЕТ", None)): 
                if (t.is_newline_after): 
                    ...
                    ok = True
            if (ok): 
                res = FragToken._new1242(t0, li.end_token, InstrumentKind.HEAD)
                if (li.begin_token != t0): 
                    hh = FragToken._new1242(t0, li.begin_token.previous, InstrumentKind.APPROVED)
                    res.children.append(hh)
                res.children.append(FragToken._new1264(li.begin_token, li.end_token, InstrumentKind.KEYWORD, True))
                return res
            t = li.end_token
            t = t.next0_; cou += 1
        return None
    ...
    def __createContractTitle(t0 : 'Token', doc : 'InstrumentReferent') -> 'FragToken':
        ...
        if (t1 is None): 
            return None
        p1 = InstrumentParticipant._new1341(par1.typ)
        ...
        if (par1.kind == ParticipantToken.Kinds.NAMEDASPARTS): 
            ...
            while ii < len(par1.parts): 
                pp = InstrumentParticipant._new1341("СТОРОНА {0}".format(ii + 1))
            ...
            if ((dttyp is not None and nam_beg is None and t.chars.is_cyrillic_letter) and (isinstance(t, TextToken))): 
                if (t.isValue("МЕЖДУ", "МІЖ")): 
                    ...
                    if (pp is not None and pp.end_token.next0_ is not None and pp.end_token.next0_.is_and): 
                        ...
                        if (pp2 is not None): 
                            fr = FragToken._new1242(t, pp2.end_token, InstrumentKind.PLACE)
        ...
        if (nam_end is not None and nam_beg is not None): 
            ...
            if (val is not None and len(val) > 3): 
                nam = FragToken._new1293(nam_beg, nam_end, InstrumentKind.NAME, val)
                ...
                if (nam_beg2 is not None and nam_end2 is not None): 
                    ...
                    if (val2 is not None and len(val2) > 3): 
                        nam = FragToken._new1293(nam_beg2, nam_end2, InstrumentKind.NAME, val2)
                        title.children.append(nam)
                        title.sortChildren()
        ...
        if (len(title.children) > 0 and title.children[0].begin_char > title.begin_char): 
            title.children.insert(0, FragToken._new1242(title.begin_token, title.children[0].begin_token.previous, InstrumentKind.UNDEFINED))
        ...
        if (par2 is not None): 
            p2 = InstrumentParticipant._new1341(par2.typ)
    ...
    def __createProjectTitle(t0 : 'Token', doc : 'InstrumentReferent') -> 'FragToken':
        ...
        while True:
            ...
            if ((isinstance(t, TextToken)) and (((t).term == "ПРОЕКТ" or (t).term == "ЗАКОНОПРОЕКТ"))): 
                if ((t.isValue("ПРОЕКТ", None) and t == t0 and (isinstance(t.next0_, ReferentToken))) and (isinstance(t.next0_.getReferent(), OrganizationReferent))): 
                    return None
                is_project = True
                title.children.append(FragToken._new1261(t, t, InstrumentKind.KEYWORD, True))
                doc.addSlot(InstrumentReferent.ATTR_TYPE, "ПРОЕКТ", False, 0)
                continue
            tt = FragToken.__attachProjectEnter(t)
            if (tt is not None): 
                is_entered = True
                title.children.append(FragToken._new1242(t, tt, InstrumentKind.APPROVED))
                t = tt
                continue
            tt = FragToken.__attachProjectMisc(t)
            if (tt is not None): 
                title.children.append(FragToken._new1242(t, tt, (InstrumentKind.EDITIONS if tt.isValue("ЧТЕНИЕ", "ЧИТАННЯ") else InstrumentKind.UNDEFINED)))
                t = tt
                continue
        ...
        if (t11 is None): 
            return None
        nam = FragToken._new1261(t00, t11, InstrumentKind.NAME, True)
    ...
    def __createJusticeParticipants(title : 'FragToken', doc : 'InstrumentReferent') -> None:
        ...
        while t is not None:
            ...
            if (tmp.tell() > 10 and t1 is not None): 
                art = InstrumentArtefact._new1355("предмет")
    ...
    def __createJustParticipant(t : 'Token', typ : str) -> 'ReferentToken':
        ...
        if (not ok): 
            return None
        pat = InstrumentParticipant._new1341(typ)
        for r in refs: 
        ...
        while True:
            ...
            if (t.isValue("ВЗЫСКАТЬ", "СТЯГНУТИ")): 
                ...
                if (sum0_ is not None): 
                    art = InstrumentArtefact._new1355("РЕЗОЛЮЦИЯ")
                    if (gosposh): 
            ...
            if (self.children[i].kind == InstrumentKind.DIRECTIVE and ((i + 1) < len(self.children))): 
                ...
                if ((((s == "РЕШЕНИЕ" or s == "ОПРЕДЕЛЕНИЕ" or s == "ПОСТАНОВЛЕНИЕ") or s == "ПРИГОВОР" or s == "РІШЕННЯ") or s == "ВИЗНАЧЕННЯ" or s == "ПОСТАНОВА") or s == "ВИРОК"): 
                    ...
                    if (ii == (i + 1)): 
                        ...
                        return FragToken._new1242(self.children[i + 1].begin_token, self.children[ii].end_token, InstrumentKind.CONTENT)
                dir0_ = True
        if (dir0_): 
            return None
        for ch in self.children: 
    ...
    def __createActionQuestion(t : 'Token', max_char : int) -> 'FragToken':
        ...
        if (res is None): 
            return None
        ques = FragToken._new1242(t, t2.previous, InstrumentKind.QUESTION)
        res.children.insert(0, ques)
        ques.children.append(FragToken._new1242(li[len(li) - 1].begin_token, li[len(li) - 1].end_token, InstrumentKind.KEYWORD))
        content = FragToken._new1242(li[len(li) - 1].end_token.next0_, t2.previous, InstrumentKind.CONTENT)
        ques.children.append(content)
        content._analizeContent(res, max_char > 0, InstrumentKind.UNDEFINED)
        if (len(li) > 1): 
            fr = FragToken._new1264(t, li[len(li) - 2].end_token, InstrumentKind.NAME, True)
    ...
    def fillByContentChildren(self) -> None:
        self.sortChildren()
        if (len(self.children) == 0): 
            self.children.append(FragToken._new1242(self.begin_token, self.end_token, InstrumentKind.CONTENT))
            return
        if (self.begin_char < self.children[0].begin_char): 
            self.children.insert(0, FragToken._new1242(self.begin_token, self.children[0].begin_token.previous, InstrumentKind.CONTENT))
        i = 0
        while i < (len(self.children) - 1): 
            if (self.children[i].end_token.next0_ != self.children[i + 1].begin_token and (self.children[i].end_token.next0_.end_char < self.children[i + 1].begin_char)): 
                self.children.insert(i + 1, FragToken._new1242(self.children[i].end_token.next0_, self.children[i + 1].begin_token.previous, InstrumentKind.CONTENT))
            i += 1
        if (self.children[len(self.children) - 1].end_char < self.end_char): 
            self.children.append(FragToken._new1242(self.children[len(self.children) - 1].end_token.next0_, self.end_token, InstrumentKind.CONTENT))
    ...
    def createDocument(t : 'Token', max_char : int, root_kind : 'InstrumentKind'=InstrumentKind.UNDEFINED) -> 'FragToken':
        ...
        if (res is not None): 
            return res
        res = FragToken._new1242(t, t, InstrumentKind.DOCUMENT)
        ...
        for i in range(i1 - 1, 0, -1):
            ...
            if ((lii.typ == ILTypes.PERSON or lii.typ == ILTypes.REGNUMBER or lii.typ == ILTypes.DATE) or lii.typ == ILTypes.GEO): 
                ...
                if (not lii.is_newline_before and not lii.begin_token.is_table_control_char and ((lii.typ == ILTypes.GEO or li[i].typ == ILTypes.PERSON))): 
                    ...
                    if (not lii.is_newline_after): 
                        if (lii.end_token.next0_ is not None and not lii.end_token.next0_.is_table_control_char): 
                            break
                if (tail is None): 
                    tail = FragToken._new1242(li[i].begin_token, li[i1 - 1].end_token, InstrumentKind.TAIL)
                    if ((i1 - 1) > i): 
                        pass
                ...
                if (li[i].is_podpis_storon and tail is not None): 
                    ...
                    tail.children.insert(0, FragToken._new1293(li[i].begin_token, li[i].end_token, InstrumentKind.NAME, ss))
                    cmax = (i - 1)
                    break
                jj = 0
                while jj < len(ss): 
        ...
        if (cmax < 0): 
            ...
            content = FragToken._new1242(li[0].begin_token, li[cmax].end_token, InstrumentKind.CONTENT)
        ...
        if (tail is not None): 
            ...
            while i1 < len(li): 
                if (li[i1].begin_token == li[i1].end_token and (isinstance(li[i1].begin_token.getReferent(), DecreeReferent)) and (li[i1].begin_token.getReferent()).kind == DecreeKind.PUBLISHER): 
                    ap = FragToken._new1242(li[i1].begin_token, li[i1].end_token, InstrumentKind.APPROVED)
                    ap.referents = list()
            ...
            if (len(tail.children) > 0 and (tail.children[len(tail.children) - 1].end_char < tail.end_char)): 
                unkw = FragToken._new1242(tail.children[len(tail.children) - 1].end_token.next0_, tail.end_token, InstrumentKind.UNDEFINED)
        ...
        while i < len(li): 
            ...
            if (li[j - 1].typ == ILTypes.PERSON and li[j - 1].is_newline_before and li[j - 1].is_newline_after): 
                tail = FragToken._new1242(li[j - 1].begin_token, li[j - 1].end_token, InstrumentKind.TAIL)
                for jj in range(j - 1, i, -1):
                    if (li[jj].typ != ILTypes.PERSON or not li[jj].is_newline_before or not li[jj].is_newline_after): 
                        break
                    else: 
                        fr = FragToken._new1242(li[jj].begin_token, li[jj].end_token, InstrumentKind.SIGNER)
            ...
            if (title is None): 
                ...
                if (is_app and app.kind == InstrumentKind.APPENDIX): 
                    ...
                    res0 = FragToken._new1379(res.begin_token, res.end_token, res._m_doc, InstrumentKind.DOCUMENT)
                    res._m_doc = (None)
                ...
                if (title.end_token.next0_ is not None): 
                    if (title.end_token.end_char < app.end_token.begin_char): 
                        acontent = FragToken._new1242(title.end_token.next0_, app.end_token, InstrumentKind.CONTENT)
    ...
    def __createCaseInfo(t : 'Token') -> 'FragToken':
        ...
        if ((not has_date and t1.next0_ is not None and (isinstance(t1.next0_.getReferent(), DateReferent))) and t1.next0_.is_newline_after): 
            t1 = t1.next0_
        return FragToken._new1242(t, t1, InstrumentKind.CASEINFO)
    ...
    def __createApproved(t : 'Token') -> 'FragToken':
        ...
        if (tt is not None): 
            res = FragToken._new1242(t, tt, InstrumentKind.APPROVED)
            ...
            if (t.morph.containsAttr("инф.", None) and t.morph.containsAttr("сов.в.", None)): 
                ...
                res = FragToken._new1242(t, t, InstrumentKind.APPROVED)
        ...
        if (dts is not None and len(dts) > 0): 
            ...
            while i < len(dts): 
                ...
                if (dt.typ == DecreeToken.ItemType.ORG): 
                    res.children.append(FragToken._new1293(dt.begin_token, dt.end_token, InstrumentKind.ORGANIZATION, dt))
                elif (dt.typ == DecreeToken.ItemType.OWNER): 
                    res.children.append(FragToken._new1293(dt.begin_token, dt.end_token, InstrumentKind.INITIATOR, dt))
                elif (dt.typ == DecreeToken.ItemType.DATE): 
                    res.children.append(FragToken._new1293(dt.begin_token, dt.end_token, InstrumentKind.DATE, dt))
                elif (dt.typ == DecreeToken.ItemType.NUMBER and i > 0 and dts[i - 1].typ == DecreeToken.ItemType.DATE): 
                    res.children.append(FragToken._new1293(dt.begin_token, dt.end_token, InstrumentKind.NUMBER, dt))
                    ...
                    res.children.append(FragToken._new1293(dt.begin_token, dt.end_token, InstrumentKind.PLACE, dt))
                else: 
                    break
    ...
    def _createMisc(t : 'Token') -> 'FragToken':
        ...
        if (t.isValue("ФОРМА", None) and t.next0_.isValue("ДОКУМЕНТА", None)): 
            ...
            if (num is not None and num.typ == DecreeToken.ItemType.NUMBER): 
                return FragToken._new1242(t, num.end_token, InstrumentKind.UNDEFINED)
            if ((isinstance(t.next0_.next0_, NumberToken)) and t.next0_.next0_.is_newline_after): 
                return FragToken._new1242(t, t.next0_.next0_, InstrumentKind.UNDEFINED)
        if (t.isValue("С", None) and t.next0_.isValue("ИЗМЕНЕНИЕ", None) and t.next0_.next0_ is not None): 
            ...
            if (isinstance(tt.getReferent(), DateReferent)): 
                if (tt.next0_ is not None and tt.next0_.isChar('.')): 
                    tt = tt.next0_
                return FragToken._new1242(t, tt, InstrumentKind.UNDEFINED)
        ...
        if (t.isValue("ЗАКАЗ", None)): 
            ...
            if (itt is not None): 
                return FragToken._new1242(t, itt.end_token, InstrumentKind.UNDEFINED)
        return None
    ...
    def _createEditions(t : 'Token') -> 'FragToken':
        ...
        if (not t.isChar('(') and not t.isValue("ПРИЛОЖЕНИЕ", "ДОДАТОК")): 
            if (t.isValue("В", "У") and t.next0_ is not None and ((t.next0_.isValue("РЕДАКЦИЯ", "РЕДАКЦІЯ") or t.next0_.isValue("РЕД", None)))): 
                ...
                if (dtt0 is not None): 
                    return FragToken._new1242(t, dtt0.end_token, InstrumentKind.EDITIONS)
            else: 
                return None
        else: 
        ...
        if (ok and not is_doubt): 
            eds = FragToken._new1242(t0, t, InstrumentKind.EDITIONS)
            eds.referents = list()
            for d in decrs: 
    ...
    def __createOwner(t : 'Token') -> 'FragToken':
        ...
        if (t1 is None): 
            return None
        fr = FragToken._new1261(t, t1, InstrumentKind.ORGANIZATION, True)
        return fr
            ...
            if (isinstance(t.getReferent(), DecreeChangeReferent)): 
                ...
                while True:
                    ...
                    if (t0 is not None and ((t0.end_char + 50) < t1.end_char)): 
                        return MetaToken._new809(t0, t1, dcr)
                    return None
            if (t.end_char > self.end_char): 
                break
            t = t.next0_
    ...
    def __createTZTitle(t0 : 'Token', doc : 'InstrumentReferent') -> 'FragToken':
        ...
        if (tz is None): 
            return None
        title = FragToken._new1242(t0, tz.end_token, InstrumentKind.HEAD)
        t = t0
        first_pass2985 = True
        while True:
            ...
            if (dt is not None): 
                ...
                if (br is not None and BracketHelper.isBracket(t.next0_, True)): 
                    nam = FragToken._new1264(br.begin_token, br.end_token, InstrumentKind.NAME, True)
                    title.children.append(nam)
                    t = br.end_token
                    title.end_token = t
                    continue
                if (t.next0_ is not None and t.next0_.isValue("НА", None)): 
                    ...
                    while True:
                        ...
                        if (npt is not None): 
                            tt = npt.end_token
                        t1 = tt
                    nam = FragToken._new1264(t.next0_, t1, InstrumentKind.NAME, True)
                    title.children.append(nam)
                    t = t1
                    title.end_token = t
                    continue
    ...
    @staticmethod
    def _new1242(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'InstrumentKind') -> 'FragToken':
        res = FragToken(_arg1, _arg2)
        res.kind = _arg3
        return res
    
    @staticmethod
    def _new1243(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'InstrToken1', _arg4 : bool) -> 'FragToken':
        res = FragToken(_arg1, _arg2)
        res._itok = _arg3
    ...
    @staticmethod
    def _new1244(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'InstrumentKind', _arg4 : bool, _arg5 : 'InstrToken1') -> 'FragToken':
        res = FragToken(_arg1, _arg2)
        res.kind = _arg3
        res._def_val2 = _arg4
        res._itok = _arg5
    ...
    @staticmethod
    def _new1251(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'InstrToken1') -> 'FragToken':
        res = FragToken(_arg1, _arg2)
        res._itok = _arg3
        return res
    
    @staticmethod
    def _new1252(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'InstrumentKind', _arg4 : 'InstrToken1') -> 'FragToken':
        res = FragToken(_arg1, _arg2)
        res.kind = _arg3
        res._itok = _arg4
        return res
    ...
    @staticmethod
    def _new1259(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'InstrumentKind', _arg4 : int) -> 'FragToken':
        res = FragToken(_arg1, _arg2)
        res.kind = _arg3
        res.number = _arg4
        return res
    ...
    @staticmethod
    def _new1261(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'InstrumentKind', _arg4 : bool) -> 'FragToken':
        res = FragToken(_arg1, _arg2)
        res.kind = _arg3
        res._def_val2 = _arg4
        return res
    ...
    @staticmethod
    def _new1264(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'InstrumentKind', _arg4 : bool) -> 'FragToken':
        res = FragToken(_arg1, _arg2)
        res.kind = _arg3
        res._def_val = _arg4
        return res
    ...
    @staticmethod
    def _new1276(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'InstrumentKind', _arg4 : object, _arg5 : 'InstrToken1') -> 'FragToken':
        res = FragToken(_arg1, _arg2)
        res.kind = _arg3
        res.value = _arg4
        res._itok = _arg5
    ...
    @staticmethod
    def _new1281(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'InstrumentKind', _arg4 : int, _arg5 : bool, _arg6 : typing.List['Referent']) -> 'FragToken':
        res = FragToken(_arg1, _arg2)
        res.kind = _arg3
        res.number = _arg4
    ...
    @staticmethod
    def _new1293(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'InstrumentKind', _arg4 : object) -> 'FragToken':
        res = FragToken(_arg1, _arg2)
        res.kind = _arg3
        res.value = _arg4
        return res
    ...
    @staticmethod
    def _new1379(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'InstrumentReferent', _arg4 : 'InstrumentKind') -> 'FragToken':
        res = FragToken(_arg1, _arg2)
        res._m_doc = _arg3
        res.kind = _arg4
        return res
    ...
    @staticmethod
    def _new1456(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'InstrumentKind', _arg4 : bool, _arg5 : 'InstrToken1') -> 'FragToken':
        res = FragToken(_arg1, _arg2)
        res.kind = _arg3
        res._def_val = _arg4
        res._itok = _arg5
