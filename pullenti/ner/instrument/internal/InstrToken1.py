...
class InstrToken1(MetaToken):
    ...
    def parse(t : 'Token', ignore_directives : bool, cur : 'FragToken'=None, lev : int=0, prev : 'InstrToken1'=None, is_citat : bool=False, max_char : int=0, can_be_table_cell : bool=False) -> 'InstrToken1':
        ...
        if (t.isChar('(')): 
            ...
            if (fr is not None): 
                edt = InstrToken1._new1430(fr.begin_token, fr.end_token, InstrToken1.Types.EDITIONS)
            else: 
                t2 = InstrToken1._createEdition(t)
                if (t2 is not None): 
                    edt = InstrToken1._new1430(t, t2, InstrToken1.Types.EDITIONS)
            if (edt is not None): 
        ...
        t0 = t
        t00 = None
        res = InstrToken1._new1432(t0, t, True)
        while t is not None: 
        ...
        if (dt is None and (((isinstance(t.getReferent(), PersonReferent)) or (isinstance(t.getReferent(), InstrumentParticipant))))): 
            dt = DecreeToken._new815(t, t, DecreeToken.ItemType.OWNER)
        ...
        if (t.isValue("КОНСУЛЬТАНТПЛЮС", None) or t.isValue("ГАРАНТ", None)): 
            ...
            if (t1 is not None and ((t1.isValue("ПРИМЕЧАНИЕ", None) or ok))): 
                if (t1.next0_ is not None and t1.next0_.isChar('.')): 
                    t1 = t1.next0_
                re = InstrToken1._new1430(t, t1, InstrToken1.Types.COMMENT)
                t1 = t1.next0_
        ...
        if (check_comment > 0 or t.isValue("О", "ПРО")): 
            ...
            while ttt is not None: 
                ...
                ttt = ttt.next0_
            if (ok): 
                cmt = InstrToken1._new1430(t, t1, InstrToken1.Types.COMMENT)
        ...
        if (tt is not None): 
            ...
            if (dt1 is not None and dt1.typ == DecreeToken.ItemType.TYP): 
                ...
                return res
        val = None
        wrapval1441 = RefOutArgWrapper(None)
        tt2 = InstrToken1._checkDirective(t, wrapval1441)
        ...
        if (tt2 is not None): 
            if (tt2.is_newline_after or ((tt2.next0_ is not None and ((tt2.next0_.isCharOf(":") or ((tt2.next0_.isChar('.') and tt2 != t)))) and ((tt2.next0_.is_newline_after or t.chars.is_all_upper))))): 
                return InstrToken1._new1436(t, (tt2 if tt2.is_newline_after else tt2.next0_), InstrToken1.Types.DIRECTIVE, val)
            ...
            if (tt is not None and tt.isCharOf(".)]")): 
                ...
                while tt is not None: 
                    ...
                    if (tt.is_newline_after): 
                        if (ok): 
                            return InstrToken1._new1430(t, tt, InstrToken1.Types.COMMENT)
                        break
                    tt = tt.next0_
        ...
        while True:
            ...
            if (t != res.begin_token and InstrToken1.__isFirstLine(t)): 
                break
            wraptmp1438 = RefOutArgWrapper(None)
            tt2 = InstrToken1._checkDirective(t, wraptmp1438)
        ...
        if (res.typ == InstrToken1.Types.LINE): 
            if (res.num_typ != NumberTypes.UNDEFINED): 
                ...
                for nn in res.numbers: 
                    wrapvv1439 = RefOutArgWrapper(0)
                    inoutres1440 = Utils.tryParseInt(nn, wrapvv1439)
                    vv = wrapvv1439.value
                    if (inoutres1440): 
    ...
    @staticmethod
    def _new1430(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Types') -> 'InstrToken1':
        res = InstrToken1(_arg1, _arg2)
        res.typ = _arg3
        return res
    
    @staticmethod
    def _new1432(_arg1 : 'Token', _arg2 : 'Token', _arg3 : bool) -> 'InstrToken1':
        res = InstrToken1(_arg1, _arg2)
        res.all_upper = _arg3
        return res
    
    @staticmethod
    def _new1436(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Types', _arg4 : str) -> 'InstrToken1':
        res = InstrToken1(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        return res
    ...
    @staticmethod
    def _new1449(_arg1 : 'Token', _arg2 : 'Token', _arg3 : bool, _arg4 : 'Types') -> 'InstrToken1':
        res = InstrToken1(_arg1, _arg2)
