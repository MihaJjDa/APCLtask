    ...
    def __parseNumber(t : 'Token', res : 'InstrToken1', prev : 'InstrToken1') -> None:
        if (((isinstance(t, NumberToken)) and (t).int_value is not None and (t).typ == NumberSpellingType.DIGIT) and ((t).int_value < 3000)): 
            ...
            if (t.morph.class0_.is_adjective and res.typ_container_rank == 0): 
                return
            nwp = NumberHelper.tryParseNumberWithPostfix(t)
            if (nwp is not None): 
            ...
            if ((t.next0_ is not None and t.next0_.is_hiphen and (isinstance(t.next0_.next0_, NumberToken))) and (t.next0_.next0_).int_value is not None and (t.next0_.next0_).int_value > (t).int_value): 
                ...
                t = t.next0_.next0_
            elif (((t.next0_ is not None and t.next0_.isCharOf(")") and t.next0_.next0_ is not None) and t.next0_.next0_.is_hiphen and (isinstance(t.next0_.next0_.next0_, NumberToken))) and (t.next0_.next0_.next0_).int_value is not None and (t.next0_.next0_.next0_).int_value > (t).int_value): 
                res.min_number = str((t).value)
    ...
    def createDiap(s1 : str, s2 : str) -> typing.List[str]:
        ...
        if (s2.startswith(s1)): 
            ...
            if (((i + 1) < len(s2)) and s2[i] == '.' and str.isdigit(s2[i + 1])): 
                wrapn21457 = RefOutArgWrapper(0)
                inoutres1458 = Utils.tryParseInt(s2[i + 1:], wrapn21457)
                n2 = wrapn21457.value
                if (inoutres1458): 
                    res0 = list()
                    res0.append(s1)
        ...
        if (((i)) > 0): 
            pref = s1[0:0+i + 1]
            wrapn11461 = RefOutArgWrapper(0)
            inoutres1462 = Utils.tryParseInt(s1[i + 1:], wrapn11461)
            n1 = wrapn11461.value
            if (not inoutres1462): 
                return None
            if (not s2.startswith(pref)): 
                return None
            wrapn21459 = RefOutArgWrapper(0)
            inoutres1460 = Utils.tryParseInt(s2[i + 1:], wrapn21459)
            n2 = wrapn21459.value
            if (not inoutres1460): 
                return None
        else: 
            wrapn11465 = RefOutArgWrapper(0)
            inoutres1466 = Utils.tryParseInt(s1, wrapn11465)
            n1 = wrapn11465.value
            if (not inoutres1466): 
                return None
            wrapn21463 = RefOutArgWrapper(0)
            inoutres1464 = Utils.tryParseInt(s2, wrapn21463)
            n2 = wrapn21463.value
            if (not inoutres1464): 
                return None
        if (n2 <= n1): 
