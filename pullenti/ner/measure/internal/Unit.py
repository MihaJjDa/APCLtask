...
class Unit:
    ...
    @staticmethod
    def _new1537(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : str, _arg5 : 'MeasureKind') -> 'Unit':
        res = Unit(_arg1, _arg2, _arg3, _arg4)
        res.kind = _arg5
        return res
    
    @staticmethod
    def _new1541(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : str, _arg5 : 'Unit', _arg6 : float, _arg7 : 'MeasureKind') -> 'Unit':
        res = Unit(_arg1, _arg2, _arg3, _arg4)
        res.base_unit = _arg5
    ...
    @staticmethod
    def _new1551(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : str, _arg5 : 'Unit', _arg6 : float) -> 'Unit':
        res = Unit(_arg1, _arg2, _arg3, _arg4)
        res.base_unit = _arg5
        res.base_multiplier = _arg6
        return res
    ...
    @staticmethod
    def _new1591(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : str, _arg5 : 'Unit', _arg6 : 'Unit') -> 'Unit':
        res = Unit(_arg1, _arg2, _arg3, _arg4)
        res.base_unit = _arg5
        res.mult_unit = _arg6
        return res
    ...
    @staticmethod
    def _new1615(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : str, _arg5 : 'UnitsFactors', _arg6 : float, _arg7 : 'Unit', _arg8 : 'MeasureKind', _arg9 : typing.List[str]) -> 'Unit':
        res = Unit(_arg1, _arg2, _arg3, _arg4)
        res.factor = _arg5
        res.base_multiplier = _arg6
        res.base_unit = _arg7
