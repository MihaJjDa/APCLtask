...
class UnitsHelper:
    ...
    def initialize() -> None:
        ...
        u = Unit._new1537("м", "m", "метр", "meter", MeasureKind.LENGTH)
        ...
        uu = Unit._new1537("миль", "mile", "морская миля", "mile", MeasureKind.LENGTH)
        uu.base_unit = u
        uu.base_multiplier = (1852)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("МИЛЯ", uu)
        t.addVariant("МОРСКАЯ МИЛЯ", False)
        t.addAbridge("NMI")
        t.addVariant("MILE", False)
        t.addVariant("NAUTICAL MILE", False)
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1541("фут", "ft", "фут", "foot", u, .304799472, MeasureKind.LENGTH)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("ФУТ", uu)
        t.addAbridge("FT.")
        t.addVariant("FOOT", False)
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1541("дюйм", "in", "дюйм", "inch", u, .0254, MeasureKind.LENGTH)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("ДЮЙМ", uu)
        t.addAbridge("IN")
        t.addVariant("INCH", False)
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1537("ар", "are", "ар", "are", MeasureKind.AREA)
        u.keywords.extend(["ПЛОЩАДЬ", "ПРОЩИНА", "AREA", "SQWARE", "SPACE"])
        UnitsHelper.UNITS.append(u)
        t = Termin._new117("АР", u)
        t.addVariant("ARE", False)
        t.addVariant("СОТКА", False)
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1537("га", "ga", "гектар", "hectare", MeasureKind.AREA)
        uu.base_unit = u
        uu.base_multiplier = (100)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("ГЕКТАР", uu)
        t.addVariant("HECTARE", False)
        t.addAbridge("ГА")
        t.addAbridge("GA")
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1537("г", "g", "грамм", "gram", MeasureKind.WEIGHT)
        u.keywords.extend(["ВЕС", "ТЯЖЕСТЬ", "НЕТТО", "БРУТТО", "МАССА", "НАГРУЗКА", "ЗАГРУЗКА", "УПАКОВКА", "WEIGHT", "NET", "GROSS", "MASS", "ВАГА", "ТЯЖКІСТЬ", "МАСА"])
        UnitsHelper.UNITS.append(u)
        t = Termin._new117("ГРАММ", u)
        t.addAbridge("Г.")
        t.addAbridge("ГР.")
        t.addAbridge("G.")
        t.addAbridge("GR.")
        ...
        uu = Unit._new1551("ц", "centner", "центнер", "centner", u, 100000)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("ЦЕНТНЕР", uu)
        t.addVariant("CENTNER", False)
        t.addVariant("QUINTAL", False)
        t.addAbridge("Ц.")
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1541("т", "t", "тонна", "tonne", u, 1000000, MeasureKind.WEIGHT)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("ТОННА", uu)
        ...
        uu = Unit._new1541("галлон", "gallon", "галлон", "gallon", u, 4.5461, MeasureKind.VOLUME)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("ГАЛЛОН", u)
        t.addVariant("ГАЛОН", False)
        t.addVariant("GALLON", False)
        t.addAbridge("ГАЛ")
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1541("баррель", "bbls", "баррель нефти", "barrel", u, 158.987, MeasureKind.VOLUME)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("БАРРЕЛЬ", uu)
        t.addAbridge("BBLS")
        t.addVariant("БАРРЕЛЬ НЕФТИ", False)
        t.addVariant("BARRREL", False)
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1537("сек", "sec", "секунда", "second", MeasureKind.TIME)
        UnitsHelper.USEC = u
        u.keywords.extend(["ВРЕМЯ", "ПРОДОЛЖИТЕЛЬНОСТЬ", "ЗАДЕРЖКА", "ДЛИТЕЛЬНОСТЬ", "ДОЛГОТА", "TIME", "DURATION", "DELAY", "ЧАС", "ТРИВАЛІСТЬ", "ЗАТРИМКА"])
        UnitsHelper.UNITS.append(u)
        t = Termin._new117("СЕКУНДА", u)
        t.addAbridge("С.")
        t.addAbridge("C.")
        t.addAbridge("СЕК")
        t.addAbridge("СЕК")
        ...
        uu = Unit._new1537("мин", "min", "минута", "minute", MeasureKind.TIME)
        uu.base_unit = u
        uu.base_multiplier = (60)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("МИНУТА", uu)
        t.addAbridge("МИН.")
        t.addAbridge("MIN.")
        ...
        UnitsHelper.TERMINS.add(t)
        u = uu
        uu = Unit._new1541("ч", "h", "час", "hour", u, 60, MeasureKind.TIME)
        UnitsHelper.UHOUR = uu
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("ЧАС", uu)
        t.addAbridge("Ч.")
        t.addAbridge("H.")
        ...
        UnitsHelper.TERMINS.add(t)
        u = Unit._new1537("дн", "d", "день", "day", MeasureKind.TIME)
        u.keywords.extend(UnitsHelper.USEC.keywords)
        u.keywords.extend(["ПОСТАВКА", "СРОК", "РАБОТА", "ЗАВЕРШЕНИЕ"])
        UnitsHelper.UNITS.append(u)
        t = Termin._new117("ДЕНЬ", u)
        t.addAbridge("ДН.")
        t.addAbridge("Д.")
        t.addVariant("DAY", False)
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1541("нед", "week", "неделя", "week", u, 7, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("НЕДЕЛЯ", uu)
        t.addAbridge("НЕД")
        t.addVariant("WEEK", False)
        t.addVariant("ТИЖДЕНЬ", False)
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1541("мес", "mon", "месяц", "month", u, 30, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("МЕСЯЦ", uu)
        t.addAbridge("МЕС")
        t.addAbridge("MON")
        t.addVariant("MONTH", False)
        t.addVariant("МІСЯЦЬ", False)
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1541("г", "year", "год", "year", u, 365, MeasureKind.TIME)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("ГОД", uu)
        t.addAbridge("Г.")
        t.addAbridge("ГД")
        ...
        t = Termin._new117("ГРАДУС", UnitsHelper.UGRADUS)
        ...
        t = Termin._new117("ГРАДУС ЦЕЛЬСИЯ", UnitsHelper.UGRADUSC)
        ...
        t = Termin._new117("ГРАДУС ФАРЕНГЕЙТА", UnitsHelper.UGRADUSF)
        ...
        t = Termin._new117("ПРОЦЕНТ", UnitsHelper.UPERCENT)
        ...
        t = Termin._new117("ОБЪЕМНЫЙ ПРОЦЕНТ", UnitsHelper.UALCO)
        ...
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("ЛОШАДИНАЯ СИЛА", uu)
        t.addAbridge("Л.С.")
        t.addAbridge("ЛОШ.С.")
        ...
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("БРИТАНСКАЯ ТЕРМИНАЛЬНАЯ ЕДИНИЦА", uu)
        t.addAbridge("БТЕ")
        t.addAbridge("BTU")
        ...
        UnitsHelper.UNITS.append(u)
        t = Termin._new117("ОМ", UnitsHelper.UOM)
        ...
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("ВОЛЬТ-АМПЕР", uu)
        t.addAbridge("BA")
        t.addAbridge("BA")
        ...
        UnitsHelper.TERMINS.add(t)
        uu = Unit._new1551("кгс", "kgf", "килограмм-сила", "kilogram-force", u, 1000)
        UnitsHelper.UNITS.append(uu)
        t = Termin._new117("КИЛОГРАММ СИЛА", uu)
        t.addAbridge("КГС")
        ...
        UnitsHelper.UNITS.append(u)
        t = Termin._new117("DOTS PER INCH", u)
    ...
    def __addFactor(f : 'UnitsFactors', u0 : 'Unit', abbr_cyr : str, abbr_lat : str, names_ru : str, names_ua : str, names_en : str) -> 'Unit':
        ...
        if (swichVal == UnitsFactors.CENTI): 
            ...
            pref_en = "TERA"
            mult = (1000000000000)
        u = Unit._new1615(pref_cyr.lower() + u0.name_cyr, pref_lat.lower() + u0.name_lat, pref_ru.lower() + u0.fullname_cyr, pref_en.lower() + u0.fullname_lat, f, mult, u0, u0.kind, u0.keywords)
        ...
        t = Termin._new117(pref_ru + nams[0], u)
        i = 1
        while i < len(nams): 
