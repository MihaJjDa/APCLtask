...
class CityItemToken(MetaToken):
            ...
            if (ci0 is None): 
                ...
                if (ci.typ == CityItemToken.ItemType.NOUN and BracketHelper.canBeStartOfSequence(t, False, False)): 
                    ...
                    if ((br is not None and (br.length_char < 50) and t.next0_.chars.is_cyrillic_letter) and not t.next0_.chars.is_all_lower): 
                        ci0 = CityItemToken._new1104(br.begin_token, br.end_token, CityItemToken.ItemType.PROPERNAME)
            ...
            if (res is None or ((res.typ != CityItemToken.ItemType.NOUN and res.typ != CityItemToken.ItemType.MISC and res.typ != CityItemToken.ItemType.CITY))): 
                ...
                if (det is not None): 
                    ...
                    while ttt is not None and ttt.end_char <= det.end_char: 
                        ...
                        ttt = ttt.next0_
                    if (cou < 6): 
                        re = CityItemToken._new1104(det.begin_token, det.end_token, CityItemToken.ItemType.PROPERNAME)
        ...
        if (res is None): 
                ...
                if (isinstance(tt, TextToken)): 
                        ...
                        if (txt == "Д" and (isinstance(tt2, NumberToken)) and not tt2.is_newline_before): 
                            ...
                            if (txt == "П" and tt.next0_ is not None and ((tt.next0_.is_hiphen or tt.next0_.isCharOf("\\/")))): 
                                ...
                                if (sit is not None and sit.typ == StreetItemType.NOUN): 
                                    ok = False
                        if (ok): 
                            res = CityItemToken._new1106(tt0, tt1, CityItemToken.ItemType.NOUN, True)
                    ...
                    if ((txt == "СП" or txt == "РП" or txt == "ГП") or txt == "ДП"): 
                        ...
                        if (tt.next0_ is not None and tt.next0_.chars.is_capital_upper): 
                            return CityItemToken._new1107(tt0, tt, CityItemToken.ItemType.NOUN, True, ("РАБОЧИЙ ПОСЕЛОК" if txt == "РП" else (("ГОРОДСКОЕ ПОСЕЛЕНИЕ" if txt == "ГП" else (("ДАЧНЫЙ ПОСЕЛОК" if txt == "ДП" else "СЕЛЬСКОЕ ПОСЕЛЕНИЕ"))))))
                    ...
                    if (tt.chars.is_all_upper and tt.length_char > 2 and tt.chars.is_cyrillic_letter): 
                        return CityItemToken._new1108(tt, tt, CityItemToken.ItemType.PROPERNAME, (tt).term)
            if ((isinstance(t, NumberToken)) and t.next0_ is not None): 
                net = NumberHelper.tryParseNumberWithPostfix(t)
                if (net is not None and net.ex_typ == NumberExType.KILOMETER): 
                    return CityItemToken._new1108(t, net.end_token, CityItemToken.ItemType.PROPERNAME, "{0}КМ".format(math.floor(net.real_value)))
            ...
            if ((rt is not None and (isinstance(rt.referent, GeoReferent)) and rt.begin_token == rt.end_token) and (rt.referent).is_state): 
                ...
                if (t.previous.morph.number == MorphNumber.SINGULAR and t.morph.case_.is_nominative and not t.morph.case_.is_genitive): 
                    return CityItemToken._new1108(t, t, CityItemToken.ItemType.PROPERNAME, rt.getSourceText().upper())
            return None
        if (res.typ == CityItemToken.ItemType.NOUN): 
                ...
                if (npt is not None and npt.end_token == res.end_token.next0_): 
                    ...
                    if (res.end_token.next0_.chars == res.begin_token.chars): 
                        ...
                        if (res.begin_token.chars.is_all_upper): 
                            cii = CityItemToken.__tryParseInt(res.end_token.next0_, loc, False, None)
    ...
    def __TryParse(t : 'Token', loc : 'IntOntologyCollection', can_be_low_char : bool=False, prev : 'CityItemToken'=None) -> 'CityItemToken':
            ...
            if ((isinstance(t, ReferentToken)) and (isinstance(t.getReferent(), DateReferent))): 
                ...
                if (aii is not None): 
                    if (len(aii) > 1 and aii[0].typ == StreetItemType.NUMBER and aii[1].typ == StreetItemType.STDNAME): 
                        res2 = CityItemToken._new1104(t, aii[1].end_token, CityItemToken.ItemType.PROPERNAME)
                ...
                for nt in li: 
                    if (nt.item is not None and nt.item.canonic_text == tt.term): 
                        if (can_be_low_char or not MiscHelper.isAllCharactersLower(nt.begin_token, nt.end_token, False)): 
                            ci = CityItemToken._new1112(nt.begin_token, nt.end_token, CityItemToken.ItemType.CITY, nt.item, nt.morph)
            ...
            if (li is not None): 
                for nt in li: 
                    if (nt.item is None): 
                        ...
                        ci = CityItemToken._new1114(nt.begin_token, nt.end_token, ty, nt.morph)
        ...
        if ((t).term == "СПБ" and not t.chars.is_all_lower and CityItemToken.M_ST_PETERBURG is not None): 
            return CityItemToken._new1115(t, t, CityItemToken.ItemType.CITY, CityItemToken.M_ST_PETERBURG, CityItemToken.M_ST_PETERBURG.canonic_text)
        ...
        if (k > 0): 
            if (k > 2): 
                return None
            reee = CityItemToken._new1116(t, t1, CityItemToken.ItemType.PROPERNAME, Utils.toStringStringIO(name), doubt)
            if (altname is not None): 
        ...
        if ((npt is not None and npt.end_token != t and len(npt.adjectives) > 0) and not npt.adjectives[0].end_token.next0_.is_comma): 
            ...
            if (cit is not None and cit.typ == CityItemToken.ItemType.NOUN and ((LanguageHelper.endsWithEx(cit.value, "ПУНКТ", "ПОСЕЛЕНИЕ", "ПОСЕЛЕННЯ", "ПОСЕЛОК") or t.next0_.isValue("ГОРОДОК", None)))): 
                return CityItemToken._new1117(t, t, CityItemToken.ItemType.CITY, t.getNormalCaseText(None, False, MorphGender.UNDEFINED, False), npt.morph)
            else: 
                ...
                if (npt1 is None or len(npt1.adjectives) == 0): 
                    ...
                    if (si is None or si.typ != StreetItemType.NOUN): 
                        ...
                        return CityItemToken._new1118(t, t1, CityItemToken.ItemType.PROPERNAME, npt.getNormalCaseText(None, False, MorphGender.UNDEFINED, False), doubt, npt.morph)
            ...
            if (ok and (isinstance(t.next0_, TextToken))): 
                ...
                if (ok1): 
                    ...
                    if (tne is not None and tne.typ == CityItemToken.ItemType.NOUN): 
                        ...
                        t1 = t.next0_
                        return CityItemToken._new1119(t, t1, CityItemToken.ItemType.PROPERNAME, Utils.toStringStringIO(name), (None if altname is None else Utils.toStringStringIO(altname)), doubt, t.next0_.morph)
        if (t.length_char < 2): 
            return None
        t1 = t
        ...
        if (MiscHelper.isEngArticle(t)): 
            return None
        res = CityItemToken._new1119(t, t1, CityItemToken.ItemType.PROPERNAME, Utils.toStringStringIO(name), (None if altname is None else Utils.toStringStringIO(altname)), doubt, t.morph)
    ...
    def initialize() -> None:
        ...
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1087("ГОРОД-ГЕРОЙ", "ГОРОД")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1122("МІСТО-ГЕРОЙ", MorphLang.UA, "МІСТО")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1087("ГОРОД-КУРОРТ", "ГОРОД")
        t.addAbridge("Г.К.")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1122("МІСТО-КУРОРТ", MorphLang.UA, "МІСТО")
        t.addAbridge("М.К.")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("СЕЛО")
        ...
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new141("ПОСЕЛКОВОЕ ПОСЕЛЕНИЕ", "ПОСЕЛОК", CityItemToken.ItemType.NOUN)
        CityItemToken.M_ONTOLOGY.add(t)
        ...
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1087("СТОЛИЦА", "ГОРОД")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1122("СТОЛИЦЯ", MorphLang.UA, "МІСТО")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("СТАНЦИЯ")
        t.addAbridge("СТАНЦ.")
        ...
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1087("РАЙОННЫЙ ЦЕНТР", "НАСЕЛЕННЫЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1122("РАЙОННИЙ ЦЕНТР", MorphLang.UA, "НАСЕЛЕНИЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1087("ГОРОДСКОЙ ОКРУГ", "НАСЕЛЕННЫЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1122("МІСЬКИЙ ОКРУГ", MorphLang.UA, "НАСЕЛЕНИЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1087("ОБЛАСТНОЙ ЦЕНТР", "НАСЕЛЕННЫЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1122("ОБЛАСНИЙ ЦЕНТР", MorphLang.UA, "НАСЕЛЕНИЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("ХУТОР")
        t.tag = CityItemToken.ItemType.NOUN
        ...
        CityItemToken.M_ONTOLOGY.add(t)
        for s in ["ЖИТЕЛЬ", "МЭР"]: 
            CityItemToken.M_ONTOLOGY.add(Termin._new117(s, CityItemToken.ItemType.MISC))
        for s in ["ЖИТЕЛЬ", "МЕР"]: 
            CityItemToken.M_ONTOLOGY.add(Termin._new455(s, MorphLang.UA, CityItemToken.ItemType.MISC))
        t = Termin._new117("АДМИНИСТРАЦИЯ", CityItemToken.ItemType.MISC)
        t.addAbridge("АДМ.")
        CityItemToken.M_ONTOLOGY.add(t)
    ...
    def __loadBigCity(xml0_ : xml.etree.ElementTree.Element) -> None:
        ...
        if (not Utils.isNullOrEmpty(adj)): 
            ...
            if (spb): 
                city_adj.add(Termin._new455(adj[6:], lang, ci))
    ...
    @staticmethod
    def _new1104(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        return res
    
    @staticmethod
    def _new1106(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : bool) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
    ...
    @staticmethod
    def _new1107(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : bool, _arg5 : str) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.geo_object_before = _arg4
        res.value = _arg5
    ...
    @staticmethod
    def _new1108(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        return res
    ...
    @staticmethod
    def _new1112(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'IntOntologyItem', _arg5 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.onto_item = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new1114(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.morph = _arg4
        return res
    ...
    @staticmethod
    def _new1115(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'IntOntologyItem', _arg5 : str) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.onto_item = _arg4
        res.value = _arg5
    ...
    @staticmethod
    def _new1116(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : bool) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.doubtful = _arg5
    ...
    @staticmethod
    def _new1117(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new1118(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : bool, _arg6 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.doubtful = _arg5
    ...
    @staticmethod
    def _new1119(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : str, _arg6 : bool, _arg7 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.alt_value = _arg5
