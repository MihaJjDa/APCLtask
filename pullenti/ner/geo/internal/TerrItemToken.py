...
class TerrItemToken(MetaToken):
    ...
    def tryParseList(t : 'Token', int_ont : 'IntOntologyCollection', max_count : int) -> typing.List['TerrItemToken']:
        ...
        while t is not None: 
            ...
            if (ci is None): 
                if (t.chars.is_capital_upper and len(li) == 1 and ((li[0].is_city_region or ((li[0].termin_item is not None and li[0].termin_item.is_specific_prefix))))): 
                ...
                elif ((BracketHelper.canBeStartOfSequence(t, False, False) and t.next0_ is not None and ((t.next0_.chars.is_capital_upper or t.next0_.chars.is_all_upper))) and len(li) == 1 and ((li[0].is_city_region or ((li[0].termin_item is not None and li[0].termin_item.is_specific_prefix))))): 
                    cit = CityItemToken.tryParse(t.next0_, int_ont, False, None)
                    if (cit is not None and ((cit.typ == CityItemToken.ItemType.PROPERNAME or cit.typ == CityItemToken.ItemType.CITY)) and BracketHelper.canBeEndOfSequence(cit.end_token.next0_, False, None, False)): 
                        ci = TerrItemToken(t, cit.end_token.next0_)
                    else: 
                        brr = BracketHelper.tryParse(t, BracketParseAttr.NO, 100)
                        if (brr is not None): 
                            ok = False
                            rt = t.kit.processReferent("ORGANIZATION", t.next0_)
                    ...
                    if (ci is not None and ci.end_token.next0_ is not None and ci.end_token.next0_.isChar(')')): 
                        ...
                        if (ci0.onto_item is not None and ci.onto_item == ci0.onto_item): 
                            ...
                            t = ci.end_token.next0_
                        continue
                if (ci is None and BracketHelper.canBeStartOfSequence(t, False, False)): 
    ...
    def __tryParseRzdDir(t : 'Token') -> 'TerrItemToken':
        ...
        while True:
            ...
            break
        if (tt0 is not None): 
            ci = TerrItemToken._new1144(tt0, tt1, True)
            if (val is not None): 
                ci.rzd_dir = val
            else: 
    ...
    def tryParse(t : 'Token', int_ont : 'IntOntologyCollection', can_be_low_capital : bool=False, noun_can_be_adjective : bool=False) -> 'TerrItemToken':
        ...
        if (res is None): 
            if (noun_can_be_adjective and t.morph.class0_.is_adjective): 
                ...
                if (tok is not None): 
                    return TerrItemToken._new1145(tok.begin_token, tok.end_token, Utils.asObjectOrNull(tok.termin.tag, TerrTermin), False)
                ...
                if (((term == "РБ" or term == "РК" or term == "TC") or term == "ТС" or term == "РТ") or term == "УР" or term == "РД"): 
                    for it in int_ont.items: 
                        if (isinstance(it.referent, GeoReferent)): 
                            ...
                            if (((alph2 == "BY" and term == "РБ")) or ((alph2 == "KZ" and term == "РК"))): 
                                return TerrItemToken._new1146(t, t, it)
                            if (term == "РТ"): 
                    ...
                    if (ok): 
                        if (term == "РК" and TerrItemToken.__m_kazahstan is not None): 
                            return TerrItemToken._new1146(t, t, TerrItemToken.__m_kazahstan)
                        if (term == "РТ" and TerrItemToken.__m_tatarstan is not None): 
                            return TerrItemToken._new1146(t, t, TerrItemToken.__m_tatarstan)
                        if (term == "РД" and TerrItemToken.__m_dagestan is not None): 
                            return TerrItemToken._new1146(t, t, TerrItemToken.__m_dagestan)
                        if (term == "УР" and TerrItemToken.__m_udmurtia is not None): 
                            return TerrItemToken._new1146(t, t, TerrItemToken.__m_udmurtia)
                        if (term == "РБ" and TerrItemToken.__m_belorussia is not None): 
                            return TerrItemToken._new1146(t, t, TerrItemToken.__m_belorussia)
                        if (((term == "ТС" or term == "TC")) and TerrItemToken.__m_tamog_sous is not None): 
                            return TerrItemToken._new1146(t, t, TerrItemToken.__m_tamog_sous)
                ...
                if (((t.morph.class0_.is_adjective or t.chars.is_all_upper or (t).term.endswith("ЖД"))) or ((t.next0_ is not None and t.next0_.is_hiphen))): 
                    ...
                    if (rt0 is not None): 
                        if ((Utils.ifNotNull(rt0.referent.getStringValue("TYPE"), "")).endswith("дорога")): 
                            return TerrItemToken._new1155(t, rt0.end_token, rt0, rt0.morph)
            ...
            for nt in li: 
                if (nt.item is not None and not ((isinstance(nt.termin.tag, IntOntologyItem)))): 
                    if (can_be_low_capital or not MiscHelper.isAllCharactersLower(nt.begin_token, nt.end_token, False) or nt.begin_token != nt.end_token): 
                        res0 = TerrItemToken._new1157(nt.begin_token, nt.end_token, nt.item, nt.morph)
            ...
            for nt in li: 
                if (nt.item is not None and (isinstance(nt.termin.tag, IntOntologyItem))): 
                    if (nt.end_token.next0_ is None or not nt.end_token.next0_.is_hiphen): 
                        res1 = TerrItemToken._new1158(nt.begin_token, nt.end_token, nt.item, True, nt.morph)
            ...
            for nt in li: 
                if (nt.termin is not None and nt.item is None): 
                    if (nt.end_token.next0_ is None or not nt.end_token.next0_.is_hiphen or not (nt.termin).is_adjective): 
                        res1 = TerrItemToken._new1159(nt.begin_token, nt.end_token, Utils.asObjectOrNull(nt.termin, TerrTermin), (nt.termin).is_adjective, nt.morph)
            ...
            if (tt.term in TerrItemToken._m_alpha2state): 
                ...
                if (isinstance(tt2, ReferentToken)): 
                    ...
                    if (r is not None and r.type_name == "PHONE"): 
                        ok = True
                if (ok): 
                    return TerrItemToken._new1146(tt, tt, TerrItemToken._m_alpha2state[tt.term])
        if (tt.length_char < 3): 
            return None
        ...
        if (npt is not None): 
            if (((npt.noun.isValue("ФЕДЕРАЦИЯ", None) or npt.noun.isValue("ФЕДЕРАЦІЯ", None))) and len(npt.adjectives) == 1): 
                if (MiscHelper.isNotMoreThanOneError("РОССИЙСКАЯ", npt.adjectives[0]) or MiscHelper.isNotMoreThanOneError("РОСІЙСЬКА", npt.adjectives[0])): 
                    return TerrItemToken._new1157(npt.begin_token, npt.end_token, (TerrItemToken.__m_russiaua if t0.kit.base_language.is_ua else TerrItemToken.__m_russiaru), npt.morph)
    ...
    def tryParseDistrictName(t : 'Token', int_ont : 'IntOntologyCollection') -> 'TerrItemToken':
        ...
        str0_ = (t).term
        res = TerrItemToken._new1162(t, t, True)
    ...
    def initialize() -> None:
        ...
        t.addAbridge("ГОС-ВО")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1164("ДЕРЖАВА", MorphLang.UA, True)
        TerrItemToken._m_terr_ontology.add(t)
        ...
        for s in ["КОРОЛЕВСТВО", "КНЯЖЕСТВО", "ГЕРЦОГСТВО", "ИМПЕРИЯ", "ЦАРСТВО", "KINGDOM", "DUCHY", "EMPIRE"]: 
            TerrItemToken._m_terr_ontology.add(TerrTermin._new1163(s, True))
        for s in ["КОРОЛІВСТВО", "КНЯЗІВСТВО", "ГЕРЦОГСТВО", "ІМПЕРІЯ"]: 
            TerrItemToken._m_terr_ontology.add(TerrTermin._new1164(s, MorphLang.UA, True))
        for s in ["НЕЗАВИСИМЫЙ", "ОБЪЕДИНЕННЫЙ", "СОЕДИНЕННЫЙ", "НАРОДНЫЙ", "НАРОДНО", "ФЕДЕРАТИВНЫЙ", "ДЕМОКРАТИЧЕСКИЙ", "СОВЕТСКИЙ", "СОЦИАЛИСТИЧЕСКИЙ", "КООПЕРАТИВНЫЙ", "ИСЛАМСКИЙ", "АРАБСКИЙ", "МНОГОНАЦИОНАЛЬНЫЙ", "СУВЕРЕННЫЙ", "САМОПРОВОЗГЛАШЕННЫЙ", "НЕПРИЗНАННЫЙ"]: 
            TerrItemToken._m_terr_ontology.add(TerrTermin._new1169(s, True, True))
        for s in ["НЕЗАЛЕЖНИЙ", "ОБЄДНАНИЙ", "СПОЛУЧЕНИЙ", "НАРОДНИЙ", "ФЕДЕРАЛЬНИЙ", "ДЕМОКРАТИЧНИЙ", "РАДЯНСЬКИЙ", "СОЦІАЛІСТИЧНИЙ", "КООПЕРАТИВНИЙ", "ІСЛАМСЬКИЙ", "АРАБСЬКИЙ", "БАГАТОНАЦІОНАЛЬНИЙ", "СУВЕРЕННИЙ"]: 
            TerrItemToken._m_terr_ontology.add(TerrTermin._new1170(s, MorphLang.UA, True, True))
        t = TerrTermin._new1171("ОБЛАСТЬ", True)
        t.addAbridge("ОБЛ.")
        TerrItemToken._m_terr_noun_adjectives.add(Termin._new117("ОБЛАСТНОЙ", t))
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1171("REGION", True)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1174("ОБЛАСТЬ", MorphLang.UA, True)
        t.addAbridge("ОБЛ.")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1175(None, True, "АО")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1176(None, MorphLang.UA, True, "АО")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1171("РАЙОН", True)
        t.addAbridge("Р-Н")
        t.addAbridge("Р-ОН")
        TerrItemToken._m_terr_noun_adjectives.add(Termin._new117("РАЙОННЫЙ", t))
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1174("РАЙОН", MorphLang.UA, True)
        t.addAbridge("Р-Н")
        t.addAbridge("Р-ОН")
        TerrItemToken._m_terr_ontology.add(t)
        ...
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1183("ШТАТ", MorphLang.UA, True, True)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1181("ПРОВИНЦИЯ", True, True)
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1183("ПРОВІНЦІЯ", MorphLang.UA, True, True)
        TerrItemToken._m_terr_ontology.add(t)
        ...
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1174("АВТОНОМІЯ", MorphLang.UA, True)
        TerrItemToken._m_terr_ontology.add(t)
        for s in ["РЕСПУБЛИКА", "КРАЙ", "ОКРУГ", "ФЕДЕРАЛЬНЫЙ ОКРУГ", "АВТОНОМНЫЙ ОКРУГ", "НАЦИОНАЛЬНЫЙ ОКРУГ", "ВОЛОСТЬ", "ФЕДЕРАЛЬНАЯ ЗЕМЛЯ", "МУНИЦИПАЛЬНЫЙ РАЙОН", "МУНИЦИПАЛЬНЫЙ ОКРУГ", "АДМИНИСТРАТИВНЫЙ ОКРУГ", "ГОРОДСКОЙ РАЙОН", "ВНУТРИГОРОДСКОЙ РАЙОН", "ВНУТРИГОРОДСКОЕ МУНИЦИПАЛЬНОЕ ОБРАЗОВАНИЕ", "REPUBLIC", "COUNTY", "BOROUGH", "PARISH", "MUNICIPALITY", "CENSUS AREA", "AUTONOMOUS REGION", "ADMINISTRATIVE REGION", "SPECIAL ADMINISTRATIVE REGION"]: 
            t = TerrTermin._new1192(s, True, " " in s)
            if (s == "КРАЙ"): 
                TerrItemToken._m_terr_noun_adjectives.add(Termin._new117("КРАЕВОЙ", t))
            elif (s == "ОКРУГ"): 
                TerrItemToken._m_terr_noun_adjectives.add(Termin._new117("ОКРУЖНОЙ", t))
        ...
        for s in ["РЕСПУБЛІКА", "КРАЙ", "ОКРУГ", "ФЕДЕРАЛЬНИЙ ОКРУГ", "АВТОНОМНЫЙ ОКРУГ", "НАЦІОНАЛЬНИЙ ОКРУГ", "ВОЛОСТЬ", "ФЕДЕРАЛЬНА ЗЕМЛЯ", "МУНІЦИПАЛЬНИЙ РАЙОН", "МУНІЦИПАЛЬНИЙ ОКРУГ", "АДМІНІСТРАТИВНИЙ ОКРУГ", "МІСЬКИЙ РАЙОН", "ВНУТРИГОРОДСКОЕ МУНІЦИПАЛЬНЕ УТВОРЕННЯ"]: 
            t = TerrTermin._new1195(s, MorphLang.UA, True, " " in s)
            if (LanguageHelper.endsWith(s, "РАЙОН")): 
                t.addAbridge(s.replace("РАЙОН", "Р-Н"))
            TerrItemToken._m_terr_ontology.add(t)
        ...
        t.addAbridge("С/О")
        TerrItemToken._m_terr_ontology.add(t)
        t = TerrTermin._new1174("СІЛЬСЬКИЙ ОКРУГ", MorphLang.UA, True)
        t.addAbridge("С.О.")
        t.addAbridge("C.O.")
        t.addAbridge("С/ОКРУГ")
        TerrItemToken._m_terr_ontology.add(t)
        ...
        t.addAbridge("П.С.")
        TerrItemToken._m_terr_ontology.add(t)
        TerrItemToken._m_terr_ontology.add(TerrTermin._new1201("АВТОНОМНЫЙ", True, True))
        TerrItemToken._m_terr_ontology.add(TerrTermin._new1202("АВТОНОМНИЙ", MorphLang.UA, True, True))
        TerrItemToken._m_terr_ontology.add(TerrTermin._new1203("МУНИЦИПАЛЬНОЕ СОБРАНИЕ", True, True, True))
        TerrItemToken._m_terr_ontology.add(TerrTermin._new1204("МУНІЦИПАЛЬНЕ ЗБОРИ", MorphLang.UA, True, True, True))
            ...
            for x in xml0_.getroot(): 
                ...
                if (x.tag == "state"): 
                    ...
                    if (a is not None and a[1] is not None): 
                        TerrItemToken._m_unknown_regions.add(Termin._new872(a[1], lang))
    ...
    def __loadState(xml0_ : xml.etree.ElementTree.Element, lang : 'MorphLang') -> None:
        ...
        for x in xml0_: 
            if (x.tag == "n"): 
                ...
                c.termins.append(Termin._new1221(Utils.getXmlInnerText(x), lang))
                state._addName(Utils.getXmlInnerText(x))
                if (acrs is None): 
                    acrs = list()
        ...
        if (a2 is not None): 
            ...
            wrapa31222 = RefOutArgWrapper(None)
            inoutres1223 = Utils.tryGetValue(MiscLocationHelper._m_alpha2_3, a2, wrapa31222)
            a3 = wrapa31222.value
            if (inoutres1223): 
    ...
    def __loadRegion(xml0_ : xml.etree.ElementTree.Element, lang : 'MorphLang') -> None:
        ...
        for x in xml0_: 
            if (x.tag == "n"): 
                ...
                if (aterm is None): 
                    aterm = Termin._new455(reg.getStringValue(GeoReferent.ATTR_NAME), lang, reg)
    ...
    @staticmethod
    def _new1144(_arg1 : 'Token', _arg2 : 'Token', _arg3 : bool) -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
        res.is_adjective = _arg3
        return res
    
    @staticmethod
    def _new1145(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'TerrTermin', _arg4 : bool) -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
    ...
    @staticmethod
    def _new1146(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'IntOntologyItem') -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
        res.onto_item = _arg3
        return res
    
    @staticmethod
    def _new1155(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ReferentToken', _arg4 : 'MorphCollection') -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
        res.rzd = _arg3
        res.morph = _arg4
        return res
    ...
    @staticmethod
    def _new1157(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'IntOntologyItem', _arg4 : 'MorphCollection') -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
        res.onto_item = _arg3
        res.morph = _arg4
        return res
    ...
    @staticmethod
    def _new1158(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'IntOntologyItem', _arg4 : bool, _arg5 : 'MorphCollection') -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
        res.onto_item = _arg3
    ...
    @staticmethod
    def _new1159(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'TerrTermin', _arg4 : bool, _arg5 : 'MorphCollection') -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
        res.termin_item = _arg3
        res.is_adjective = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new1162(_arg1 : 'Token', _arg2 : 'Token', _arg3 : bool) -> 'TerrItemToken':
        res = TerrItemToken(_arg1, _arg2)
        res.is_doubt = _arg3
        return res
