...
class PhoneItemToken(MetaToken):
    ...
    def __TryAttach(t0 : 'Token') -> 'PhoneItemToken':
        ...
        if (isinstance(t0, NumberToken)): 
            if (NumberHelper.tryParseNumberWithPostfix(t0) is not None and not t0.is_whitespace_after): 
                rt = t0.kit.processReferent("PHONE", t0.next0_)
                if (rt is None): 
                    return None
            if ((t0).typ == NumberSpellingType.DIGIT and not t0.morph.class0_.is_adjective): 
                return PhoneItemToken._new2466(t0, t0, PhoneItemToken.PhoneItemType.NUMBER, t0.getSourceText())
            return None
        if (t0.isChar('.')): 
            return PhoneItemToken._new2466(t0, t0, PhoneItemToken.PhoneItemType.DELIM, ".")
        if (t0.is_hiphen): 
            return PhoneItemToken._new2466(t0, t0, PhoneItemToken.PhoneItemType.DELIM, "-")
        if (t0.isChar('+')): 
            if (not ((isinstance(t0.next0_, NumberToken))) or (t0.next0_).typ != NumberSpellingType.DIGIT): 
                ...
                if (i > 0): 
                    val = val[i:]
                return PhoneItemToken._new2466(t0, t0.next0_, PhoneItemToken.PhoneItemType.COUNTRYCODE, val)
        ...
        if (t0.isCharOf("(")): 
            if (isinstance(t0.next0_, NumberToken)): 
                ...
                if (et is None or val.tell() == 0): 
                    ...
                    return PhoneItemToken._new2471(t0, et, PhoneItemToken.PhoneItemType.CITYCODE, Utils.toStringStringIO(val), True)
            else: 
                ...
                if (tt1 is None or tt1.termin.tag is not None): 
                    ...
                    return PhoneItemToken._new2472(t0, tt1.end_token.next0_, PhoneItemToken.PhoneItemType.PREFIX, True, "")
                return None
        if ((t0.isChar('/') and (isinstance(t0.next0_, NumberToken)) and t0.next0_.next0_ is not None) and t0.next0_.next0_.isChar('/') and t0.next0_.length_char == 3): 
            return PhoneItemToken._new2471(t0, t0.next0_.next0_, PhoneItemToken.PhoneItemType.CITYCODE, str((t0.next0_).value), True)
        t1 = None
        ...
        if ((t0.isValue("Т", None) and t0.next0_ is not None and t0.next0_.isCharOf("\\/")) and t0.next0_.next0_ is not None and ((t0.next0_.next0_.isValue("Р", None) or t0.next0_.next0_.isValue("М", None)))): 
            ...
            t1 = tt.end_token
        res = PhoneItemToken._new2474(t0, t1, PhoneItemToken.PhoneItemType.PREFIX, "", ki)
        while True:
    ...
    def tryAttachAdditional(t0 : 'Token') -> 'PhoneItemToken':
        ...
        if (t.isChar(',')): 
            ...
            if (len(val0) >= 3 and (len(val0) < 7)): 
                return PhoneItemToken._new2466(t, t1, PhoneItemToken.PhoneItemType.ADDNUMBER, val0)
        br = False
        ...
        if (br): 
            if (t.next0_ is None or not t.next0_.isChar(')')): 
                return None
            t = t.next0_
        res = PhoneItemToken._new2466(t0, t, PhoneItemToken.PhoneItemType.ADDNUMBER, val)
        return res
    ...
    def tryAttachAll(t0 : 'Token') -> typing.List['PhoneItemToken']:
        ...
        while True:
            ...
            if (p.item_type == PhoneItemToken.PhoneItemType.NUMBER and res[len(res) - 1].item_type == PhoneItemToken.PhoneItemType.NUMBER): 
                res.append(PhoneItemToken._new2466(t, t, PhoneItemToken.PhoneItemType.DELIM, " "))
            if (br): 
                p.is_in_brackets = True
            res.append(p)
            t = p.end_token
    ...
    def tryAttachAlternate(t0 : 'Token', ph0 : 'PhoneReferent', pli : typing.List['PhoneItemToken']) -> 'PhoneItemToken':
            ...
            if (pli1 is not None and len(pli1) > 1): 
                ...
                if (len(pli1) <= len(pli)): 
                    ...
                    while ii < len(pli1): 
                        ...
                        ii += 1
                    if (ii >= len(pli1)): 
                        return PhoneItemToken._new2466(t0, pli1[len(pli1) - 1].end_token, PhoneItemToken.PhoneItemType.ALT, num)
            return PhoneItemToken._new2466(t0, t0.next0_, PhoneItemToken.PhoneItemType.ALT, t0.next0_.getSourceText())
        ...
        if ((t0.isChar('(') and (isinstance(t0.next0_, NumberToken)) and (t0.next0_.end_char - t0.next0_.begin_char) == 1) and t0.next0_.next0_ is not None and t0.next0_.next0_.isChar(')')): 
            return PhoneItemToken._new2466(t0, t0.next0_.next0_, PhoneItemToken.PhoneItemType.ALT, t0.next0_.getSourceText())
    ...
    @staticmethod
    def _new2466(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PhoneItemType', _arg4 : str) -> 'PhoneItemToken':
    ...
    @staticmethod
    def _new2471(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PhoneItemType', _arg4 : str, _arg5 : bool) -> 'PhoneItemToken':
        res = PhoneItemToken(_arg1, _arg2)
        res.item_type = _arg3
        res.value = _arg4
    ...
    @staticmethod
    def _new2472(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PhoneItemType', _arg4 : bool, _arg5 : str) -> 'PhoneItemToken':
        res = PhoneItemToken(_arg1, _arg2)
        res.item_type = _arg3
    ...
    @staticmethod
    def _new2474(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PhoneItemType', _arg4 : str, _arg5 : 'PhoneKind') -> 'PhoneItemToken':
        res = PhoneItemToken(_arg1, _arg2)
        res.item_type = _arg3
        res.value = _arg4
        res.kind = _arg5
