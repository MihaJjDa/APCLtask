...
class StreetItemToken(MetaToken):
    ...
    def _tryParse(t : 'Token', loc_streets : 'IntOntologyCollection', recurse : bool, prev : 'StreetItemToken', ignore_onto : bool) -> 'StreetItemToken':
        ...
        if (nt is not None and nt.int_value is not None): 
            return StreetItemToken._new217(nt.begin_token, nt.end_token, StreetItemType.AGE, nt)
        nt = Utils.asObjectOrNull(t, NumberToken)
        if ((nt) is not None): 
            if ((nt).int_value is None or (nt).int_value == 0): 
                return None
            res = StreetItemToken._new218(nt, nt, StreetItemType.NUMBER, nt, nt.morph)
        ...
        if ((ntt is not None and (isinstance(ntt, NumberToken)) and prev is not None) and (ntt).int_value is not None): 
            return StreetItemToken._new219(t, ntt, StreetItemType.NUMBER, Utils.asObjectOrNull(ntt, NumberToken), True)
            ...
            if (tt.chars.is_capital_upper or ((prev is not None and prev.typ == StreetItemType.NUMBER and tt.isValue("ТРАНСПОРТНЫЙ", None)))): 
                ...
                if (tte is not None): 
                    if ((((((((((tte.isValue("ВАЛ", None) or tte.isValue("ТРАКТ", None) or tte.isValue("ПОЛЕ", None)) or tte.isValue("МАГИСТРАЛЬ", None) or tte.isValue("СПУСК", None)) or tte.isValue("ВЗВОЗ", None) or tte.isValue("РЯД", None)) or tte.isValue("СЛОБОДА", None) or tte.isValue("РОЩА", None)) or tte.isValue("ПРУД", None) or tte.isValue("СЪЕЗД", None)) or tte.isValue("КОЛЬЦО", None) or tte.isValue("МАГІСТРАЛЬ", None)) or tte.isValue("УЗВІЗ", None) or tte.isValue("ЛІНІЯ", None)) or tte.isValue("УЗВІЗ", None) or tte.isValue("ГАЙ", None)) or tte.isValue("СТАВОК", None) or tte.isValue("ЗЇЗД", None)) or tte.isValue("КІЛЬЦЕ", None)): 
                        sit = StreetItemToken._new220(tt, tte, True)
                ...
                if (npt is not None and npt.begin_token != npt.end_token and len(npt.adjectives) <= 1): 
                    ...
                    if (ok): 
                        ...
                        if (sti1 is not None and sti1.typ == StreetItemType.NOUN): 
                            ...
                            tok2 = StreetItemToken.__m_ontology.tryParse(npt.end_token, TerminParseAttr.NO)
                            if (tok2 is not None): 
        ...
        if (((tt is not None and tt.length_char == 1 and tt.chars.is_all_lower) and tt.next0_ is not None and tt.next0_.isChar('.')) and tt.kit.base_language.is_ru): 
            if (tt.isValue("М", None) or tt.isValue("M", None)): 
                if (prev is not None and prev.typ == StreetItemType.NOUN): 
                    ...
                    return StreetItemToken._new221(tt, tt.next0_, StreetItemToken.__m_metro, StreetItemType.NOUN, True)
        ot = None
        ...
        if (ot is not None and ot.begin_token == ot.end_token and ot.morph.class0_.is_adjective): 
            ...
            if (tok0 is not None): 
                if ((Utils.valToEnum(tok0.termin.tag, StreetItemType)) == StreetItemType.STDADJECTIVE): 
                    ot = (None)
        if (ot is not None): 
            res0 = StreetItemToken._new222(ot.begin_token, ot.end_token, StreetItemType.NAME, Utils.asObjectOrNull(ot.item.referent, StreetReferent), ot.morph, True)
            return res0
        ...
        if (tok is not None and not ignore_onto): 
            if ((Utils.valToEnum(tok.termin.tag, StreetItemType)) == StreetItemType.NUMBER): 
                if ((isinstance(tok.end_token.next0_, NumberToken)) and (tok.end_token.next0_).int_value is not None): 
                    return StreetItemToken._new223(t, tok.end_token.next0_, StreetItemType.NUMBER, Utils.asObjectOrNull(tok.end_token.next0_, NumberToken), True, tok.morph)
                return None
            if (tt is None): 
                return None
            abr = True
            ...
            if (swichVal == StreetItemType.STDADJECTIVE): 
                        ...
                        if (not tok.end_token.isChar('.')): 
                            ...
                            if (tok.end_token.is_newline_after and prev is not None): 
                                ...
                                if (next0__ is not None and ((next0__.typ == StreetItemType.NAME or next0__.typ == StreetItemType.NOUN))): 
                                    ...
                                    oo2 = True
                            if (oo2): 
                                return StreetItemToken._new224(tok.begin_token, tok.end_token, StreetItemType.STDADJECTIVE, tok.termin, abr, tok.morph)
                            break
                ...
                while True:
                    ...
                    return StreetItemToken._new226(tok.begin_token, tok.end_token, StreetItemType.NOUN, tok.termin, alt, abr, tok.morph, (tok.termin.tag2 if isinstance(tok.termin.tag2, int) else 0))
                ...
                if (tok.begin_token.chars.is_all_lower and not is_post_off and tok.end_token.chars.is_all_lower): 
                    return None
                sits = StreetItemToken._new227(tok.begin_token, tok.end_token, StreetItemType.STDNAME, tok.morph, tok.termin.canonic_text)
                ...
                if (sit is None): 
                    if (tok.morph.number == MorphNumber.PLURAL): 
                        return StreetItemToken._new227(tok.begin_token, tok.end_token, StreetItemType.NAME, tok.morph, MiscHelper.getTextValueOfMetaToken(tok, GetTextAttr.NO))
                    return None
        ...
        if (tt is not None): 
            ...
            if (tt.chars.is_cyrillic_letter and tt.length_char > 1 and not tt.morph.class0_.is_preposition): 
                if (tt.isValue("ГЕРОЙ", None) or tt.isValue("ЗАЩИТНИК", "ЗАХИСНИК")): 
                    if ((isinstance(tt.next0_, ReferentToken)) and (isinstance(tt.next0_.getReferent(), GeoReferent))): 
                        re = StreetItemToken._new234(tt, tt.next0_, StreetItemType.STDPARTOFNAME, MiscHelper.getTextValue(tt, tt.next0_, GetTextAttr.NO))
                        ...
                        if (sit is None or sit.typ != StreetItemType.NAME): 
                            ...
                            if (sit is not None and ((sit.typ == StreetItemType.STDADJECTIVE or sit.typ == StreetItemType.NOUN))): 
                                ...
                                ok2 = True
                            if (ok2): 
                                sit = StreetItemToken._new235(tt, tt.next0_, StreetItemType.NAME)
                            ...
                            if (nn is None or nn.typ == StreetItemType.NAME): 
                                ...
                                if (npt is not None): 
                                    if (npt.begin_token == npt.end_token): 
                                        npt = (None)
                                    elif (StreetItemToken.__m_ontology.tryParse(npt.end_token, TerminParseAttr.NO) is not None): 
                                        npt = (None)
                                ...
                                if (npt is not None and npt.end_token == nn.end_token): 
                                    ...
                                    var = Morphology.getWordform(res.value, MorphBaseInfo._new238(MorphCase.NOMINATIVE, MorphClass.ADJECTIVE, MorphNumber.SINGULAR, npt.morph.gender))
            ...
            if (((tt.isValue("РЕКА", None) or tt.isValue("РІЧКА", None))) and tt.next0_ is not None and tt.next0_.chars.is_capital_upper): 
                return StreetItemToken._new239(tt, tt.next0_, StreetItemType.NAME, tt.morph, tt.next0_.getSourceText().upper())
            if (tt.isValue("№", None) or tt.isValue("НОМЕР", None) or tt.isValue("НОМ", None)): 
                ...
                if ((isinstance(tt1, NumberToken)) and (tt1).int_value is not None): 
                    return StreetItemToken._new219(tt, tt1, StreetItemType.NUMBER, Utils.asObjectOrNull(tt1, NumberToken), True)
            if (tt.is_hiphen and (isinstance(tt.next0_, NumberToken)) and (tt.next0_).int_value is not None): 
                if (prev is not None and prev.typ == StreetItemType.NOUN): 
                    if (prev.termin.canonic_text == "МИКРОРАЙОН" or LanguageHelper.endsWith(prev.termin.canonic_text, "ГОРОДОК")): 
                        return StreetItemToken._new219(tt, tt.next0_, StreetItemType.NUMBER, Utils.asObjectOrNull(tt.next0_, NumberToken), True)
        ...
        if (isinstance(r, GeoReferent)): 
            ...
            if (prev is not None and prev.typ == StreetItemType.NOUN): 
                if (AddressItemToken.checkHouseAfter(t.next0_, False, False)): 
                    return StreetItemToken._new234(t, t, StreetItemType.NAME, MiscHelper.getTextValue(t, t, GetTextAttr.NO))
        if (((isinstance(tt, TextToken)) and tt.chars.is_capital_upper and tt.chars.is_latin_letter) and (tt.whitespaces_after_count < 2)): 
            ...
            if (tok1 is not None): 
                return StreetItemToken._new227(tt, tt2.previous, StreetItemType.NAME, tt.morph, (tt).term)
        return None
    ...
    def _tryParseSpec(t : 'Token', prev : 'StreetItemToken') -> typing.List['StreetItemToken']:
        ...
        if (isinstance(t.getReferent(), DateReferent)): 
            ...
            if (dr.year == 0 and dr.day > 0 and dr.month > 0): 
                res = list()
                res.append(StreetItemToken._new217(t, t, StreetItemType.NUMBER, NumberToken(t, t, str(dr.day), NumberSpellingType.DIGIT)))
            ...
            if (dr.year > 0 and dr.month == 0): 
                res = list()
                res.append(StreetItemToken._new217(t, t, StreetItemType.NUMBER, NumberToken(t, t, str(dr.year), NumberSpellingType.DIGIT)))
        ...
        if (prev is not None and prev.typ == StreetItemType.AGE): 
            ...
            if (isinstance(t.getReferent(), GeoReferent)): 
                sit = StreetItemToken._new248(t, t, StreetItemType.NAME, t.getSourceText().upper(), t.getReferent().toString(True, t.kit.base_language, 0).upper())
                res.append(sit)
        ...
        if (prev is not None and prev.typ == StreetItemType.NOUN): 
            ...
            if (num is not None and num.int_value is not None): 
                res = list()
                sit = StreetItemToken._new217(num.begin_token, num.end_token, StreetItemType.NUMBER, num)
                res.append(sit)
            ...
            if (t.isChar('.') and sit is not None and sit.typ == StreetItemType.NOUN): 
                ...
                if (sit is None): 
                    ...
                    if (((isinstance(t, TextToken)) and ((len(res) == 2 or len(res) == 3)) and res[0].typ == StreetItemType.NOUN) and res[1].typ == StreetItemType.NUMBER and ((((t).term == "ГОДА" or (t).term == "МАЯ" or (t).term == "МАРТА") or (t).term == "СЪЕЗДА"))): 
                        sit = StreetItemToken._new234(t, t, StreetItemType.STDNAME, (t).term)
                        res.append(sit)
                        continue
                    sit = res[len(res) - 1]
                    if (t is None): 
                    ...
                    if (sit.typ == StreetItemType.NOUN and ((sit.termin.canonic_text == "МИКРОРАЙОН" or sit.termin.canonic_text == "МІКРОРАЙОН")) and (t.whitespaces_before_count < 2)): 
                        ...
                        if (((isinstance(tt1, TextToken)) and tt1.length_char == 1 and tt1.chars.is_letter) and ((AddressItemToken.checkHouseAfter(tt2, False, True) or tt2 is None))): 
                            sit = StreetItemToken._new234(t, (tt1.next0_ if br else tt1), StreetItemType.NAME, (tt1).term)
                        ...
                        if (sit1.typ == StreetItemType.NOUN and ((sit1.noun_is_doubt_coef == 0 or (((isinstance(t.next0_, TextToken)) and not t.next0_.chars.is_all_lower))))): 
                            ...
                            if (br is not None and (br.length_char < 50)): 
                                ...
                                if (sit2 is not None and sit2.end_token.next0_ == br.end_token): 
                                    ...
                                    res.append(sit2)
                                    continue
                                res.append(StreetItemToken._new253(t, br.end_token, StreetItemType.NAME, MiscHelper.getTextValue(t, br.end_token, GetTextAttr.NO), True))
                                t = br.end_token
                                continue
                    if (t.is_hiphen and (isinstance(t.next0_, NumberToken)) and (t.next0_).int_value is not None): 
                        ...
                        if (sit.typ == StreetItemType.NOUN and (((sit.termin.canonic_text == "КВАРТАЛ" or sit.termin.canonic_text == "МИКРОРАЙОН" or sit.termin.canonic_text == "ГОРОДОК") or sit.termin.canonic_text == "МІКРОРАЙОН"))): 
                            sit = StreetItemToken._new219(t, t.next0_, StreetItemType.NUMBER, Utils.asObjectOrNull(t.next0_, NumberToken), True)
                            res.append(sit)
                            t = t.next0_
                            continue
                    break
                ...
                if (tt is not None and (isinstance(tt.getReferent(), GeoReferent))): 
                    ...
                    if (g2 is not None): 
                        if (g1.is_city and g2.is_city): 
                            nam = StreetItemToken._new235(res[0].end_token.next0_, tt, StreetItemType.NAME)
    ...
    def initialize() -> None:
        ...
        t.addAbridge("ВУЛ.")
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("STREET", StreetItemType.NOUN)
        t.addAbridge("ST.")
        StreetItemToken.__m_ontology.add(t)
        ...
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("SQUARE", StreetItemType.NOUN)
        t.addAbridge("SQ.")
        StreetItemToken.__m_ontology.add(t)
        ...
        t.addAbridge("ПРОВ.")
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new119("LANE", StreetItemType.NOUN, 0)
        t.addAbridge("LN.")
        StreetItemToken.__m_ontology.add(t)
        ...
        t.addAbridge("Б-РЕ")
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new119("BOULEVARD", StreetItemType.NOUN, 0)
        t.addAbridge("BLVD")
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new119("СКВЕР", StreetItemType.NOUN, 1)
        StreetItemToken.__m_ontology.add(t)
        ...
        t.addAbridge("АЛ.")
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new119("ALLEY", StreetItemType.NOUN, 0)
        t.addAbridge("ALY.")
        StreetItemToken.__m_ontology.add(t)
        ...
        t.addAbridge("Ш.")
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new119("ROAD", StreetItemType.NOUN, 1)
        t.addAbridge("RD.")
        StreetItemToken.__m_ontology.add(t)
        ...
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new119("HILL", StreetItemType.NOUN, 0)
        t.addAbridge("HL.")
        StreetItemToken.__m_ontology.add(t)
        ...
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new119("PLAZA", StreetItemType.NOUN, 1)
        t.addAbridge("PLZ")
        StreetItemToken.__m_ontology.add(t)
        ...
        StreetItemToken.__m_ontology.add(t)
        StreetItemToken.__m_ontology.add(Termin._new117("САДОВОЕ КОЛЬЦО", StreetItemType.FIX))
        StreetItemToken.__m_ontology.add(Termin._new117("БУЛЬВАРНОЕ КОЛЬЦО", StreetItemType.FIX))
        StreetItemToken.__m_ontology.add(Termin._new117("ТРАНСПОРТНОЕ КОЛЬЦО", StreetItemType.FIX))
        ...
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("БОЛЬШОЙ", StreetItemType.STDADJECTIVE)
        t.addAbridge("БОЛ.")
        t.addAbridge("Б.")
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new118("ВЕЛИКИЙ", StreetItemType.STDADJECTIVE, MorphLang.UA)
        t.addAbridge("ВЕЛ.")
        t.addAbridge("В.")
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("МАЛЫЙ", StreetItemType.STDADJECTIVE)
        t.addAbridge("МАЛ.")
        t.addAbridge("М.")
        t.addVariant("МАЛИЙ", False)
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("СРЕДНИЙ", StreetItemType.STDADJECTIVE)
        t.addAbridge("СРЕД.")
        t.addAbridge("СР.")
        t.addAbridge("С.")
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new118("СЕРЕДНІЙ", StreetItemType.STDADJECTIVE, MorphLang.UA)
        t.addAbridge("СЕРЕД.")
        t.addAbridge("СЕР.")
        t.addAbridge("С.")
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("ВЕРХНИЙ", StreetItemType.STDADJECTIVE)
        t.addAbridge("ВЕРХН.")
        t.addAbridge("ВЕРХ.")
        t.addAbridge("ВЕР.")
        t.addAbridge("В.")
        ...
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("НИЖНИЙ", StreetItemType.STDADJECTIVE)
        t.addAbridge("НИЖН.")
        t.addAbridge("НИЖ.")
        t.addAbridge("Н.")
        t.addVariant("НИЖНІЙ", False)
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("СТАРЫЙ", StreetItemType.STDADJECTIVE)
        t.addAbridge("СТАР.")
        t.addAbridge("СТ.")
        t.addVariant("СТАРИЙ", False)
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("НОВЫЙ", StreetItemType.STDADJECTIVE)
        t.addAbridge("НОВ.")
        t.addVariant("НОВИЙ", False)
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("НОМЕР", StreetItemType.STDADJECTIVE)
        t.addAbridge("N")
        t.addAbridge("№")
        t.addAbridge("НОМ.")
        StreetItemToken.__m_ontology.add(t)
        for s in ["ФРИДРИХА ЭНГЕЛЬСА", "КАРЛА МАРКСА", "РОЗЫ ЛЮКСЕМБУРГ"]: 
            t = Termin._new117(s, StreetItemType.STDNAME)
            t.addAllAbridges(0, 0, 0)
            StreetItemToken.__m_ontology.add(t)
        for s in ["МАРТА", "МАЯ", "ОКТЯБРЯ", "НОЯБРЯ", "БЕРЕЗНЯ", "ТРАВНЯ", "ЖОВТНЯ", "ЛИСТОПАДА"]: 
            StreetItemToken.__m_ontology.add(Termin._new117(s, StreetItemType.STDNAME))
        for s in ["МАРШАЛА", "ГЕНЕРАЛА", "АДМИРАЛА", "КОСМОНАВТА", "ЛЕТЧИКА", "АВИАКОНСТРУКТОРА", "АРХИТЕКТОРА", "СКУЛЬПТОРА", "ХУДОЖНИКА", "КОНСТРУКТОРА", "АКАДЕМИКА", "ПРОФЕССОРА", "ЛЕЙТЕНАНТА", "КАПИТАНА", "МАЙОРА", "ПОДПОЛКОВНИКА", "ПОЛКОВНИКА", "ПОЛИЦИИ", "МИЛИЦИИ"]: 
            ...
            t = Termin._new117(s, StreetItemType.STDPARTOFNAME)
        ...
        for s in ["МАРШАЛА", "ГЕНЕРАЛА", "АДМІРАЛА", "КОСМОНАВТА", "ЛЬОТЧИКА", "АВІАКОНСТРУКТОРА", "АРХІТЕКТОРА", "СКУЛЬПТОРА", "ХУДОЖНИКА", "КОНСТРУКТОРА", "АКАДЕМІКА", "ПРОФЕСОРА", "ЛЕЙТЕНАНТА", "КАПІТАН", "МАЙОР", "ПІДПОЛКОВНИК", "ПОЛКОВНИК", "ПОЛІЦІЇ", "МІЛІЦІЇ"]: 
            StreetItemToken.__m_std_ont_misc.add(Termin(s))
            t = Termin._new118(s, StreetItemType.STDPARTOFNAME, MorphLang.UA)
            t.addAllAbridges(0, 0, 2)
            t.addAllAbridges(2, 5, 0)
            t.addAbridge("ГЛ." + s)
            t.addAbridge("ГЛАВ." + s)
            StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("ВАСИЛЬЕВСКОГО ОСТРОВА", StreetItemType.STDNAME)
        t.addAbridge("В.О.")
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("ПЕТРОГРАДСКОЙ СТОРОНЫ", StreetItemType.STDNAME)
        t.addAbridge("П.С.")
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("ОЛИМПИЙСКАЯ ДЕРЕВНЯ", StreetItemType.FIX)
        t.addAbridge("ОЛИМП. ДЕРЕВНЯ")
        t.addAbridge("ОЛИМП. ДЕР.")
        StreetItemToken.__m_ontology.add(t)
        t = Termin._new117("ЛЕНИНСКИЕ ГОРЫ", StreetItemType.FIX)
        StreetItemToken.__m_ontology.add(t)
    ...
    @staticmethod
    def _new217(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'NumberToken') -> 'StreetItemToken':
    ...
    @staticmethod
    def _new218(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'NumberToken', _arg5 : 'MorphCollection') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.number = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new219(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'NumberToken', _arg5 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.number = _arg4
    ...
    @staticmethod
    def _new220(_arg1 : 'Token', _arg2 : 'Token', _arg3 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.has_std_suffix = _arg3
        return res
    
    @staticmethod
    def _new221(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Termin', _arg4 : 'StreetItemType', _arg5 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.termin = _arg3
        res.typ = _arg4
    ...
    @staticmethod
    def _new222(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'StreetReferent', _arg5 : 'MorphCollection', _arg6 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
    ...
    @staticmethod
    def _new223(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'NumberToken', _arg5 : bool, _arg6 : 'MorphCollection') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.number = _arg4
        res.number_has_prefix = _arg5
    ...
    @staticmethod
    def _new224(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'Termin', _arg5 : bool, _arg6 : 'MorphCollection') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.termin = _arg4
        res.is_abridge = _arg5
    ...
    @staticmethod
    def _new226(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'Termin', _arg5 : 'Termin', _arg6 : bool, _arg7 : 'MorphCollection', _arg8 : int) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.termin = _arg4
    ...
    @staticmethod
    def _new227(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'MorphCollection', _arg5 : str) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.morph = _arg4
        res.value = _arg5
