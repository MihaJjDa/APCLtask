...
class AddressItemToken(MetaToken):
            ...
            if (it0 is None): 
                        ...
                        if (tt1.is_comma): 
                            ...
                            if (tt1.isValue("Л", None) and tt1.next0_ is not None and tt1.next0_.isChar('.')): 
                                ...
                                if (ait is not None and ait.typ == AddressItemToken.ItemType.NUMBER): 
                                    ...
                                    it = AddressItemToken._new82(AddressItemToken.ItemType.STREET, tt1, ait.end_token, st2)
                                    res.append(it)
                                    t = it.end_token
                            break
                        tt1 = tt1.next0_
                ...
                if (it.typ == AddressItemToken.ItemType.HOUSE or it.typ == AddressItemToken.ItemType.BUILDING or it.typ == AddressItemToken.ItemType.NUMBER): 
                    if ((not t.is_whitespace_before and t.length_char == 1 and t.chars.is_letter) and not t.is_whitespace_after and (isinstance(t.next0_, NumberToken))): 
                        ...
                        if (ch == "К" or ch == "С"): 
                            it0 = AddressItemToken._new83((AddressItemToken.ItemType.CORPUS if ch == "К" else AddressItemToken.ItemType.BUILDING), t, t.next0_, str((t.next0_).value))
                            it = it0
                            res.append(it)
                            t = it.end_token
                            tt = t.next0_
                            if (((tt is not None and not tt.is_whitespace_before and tt.length_char == 1) and tt.chars.is_letter and not tt.is_whitespace_after) and (isinstance(tt.next0_, NumberToken))): 
                                ...
                                if (ch == "К" or ch == "С"): 
                                    it = AddressItemToken._new83((AddressItemToken.ItemType.CORPUS if ch == "К" else AddressItemToken.ItemType.BUILDING), tt, tt.next0_, str((tt.next0_).value))
                                    res.append(it)
                                    t = it.end_token
                            continue
                if (t.morph.class0_.is_preposition): 
        ...
        while i < (len(res) - 1): 
            if (res[i].is_terr_or_rzd and res[i + 1].typ == AddressItemToken.ItemType.KILOMETER and (((i + 1) >= len(res) or not res[i + 1].is_terr_or_rzd))): 
                ...
                if ((res[i].value is None and ((i + 2) < len(res)) and res[i + 2].typ == AddressItemToken.ItemType.NUMBER) and res[i + 2].value is not None): 
                    ...
                    remove2 = True
                ai = AddressItemToken._new85(AddressItemToken.ItemType.STREET, res[i].begin_token, t11, str0_, False)
                res[i] = ai
                del res[i + 1]
                if (remove2): 
                    del res[i + 1]
    ...
    def __TryParse(t : 'Token', loc_streets : 'IntOntologyCollection', prefix_before : bool, ignore_street : bool, prev : 'AddressItemToken') -> 'AddressItemToken':
        ...
        if (isinstance(t, ReferentToken)): 
            ...
            if (geo is not None): 
                ...
                return AddressItemToken._new82(ty, t, t, rt.referent)
        ...
        if (isinstance(t, NumberToken)): 
            ...
            if (((n.length_char == 6 or n.length_char == 5)) and n.typ == NumberSpellingType.DIGIT and not n.morph.class0_.is_adjective): 
                return AddressItemToken._new83(AddressItemToken.ItemType.ZIP, t, t, str(n.value))
            ok = False
                ...
                if (typ0 == AddressItemToken.ItemType.FLAT): 
                    ...
                    if ((isinstance(tok0.end_token.next0_, NumberToken)) and (tok0.end_token.whitespaces_after_count < 3)): 
                        if (prev is not None and ((prev.typ == AddressItemToken.ItemType.STREET or prev.typ == AddressItemToken.ItemType.CITY))): 
                            return AddressItemToken._new83(AddressItemToken.ItemType.NUMBER, t, t, str(n.value))
        ...
        if (tok is not None): 
            ...
            if (tok.termin.canonic_text == "ТАМ ЖЕ"): 
                ...
                while True:
                    ...
                    if (isinstance(r, AddressReferent)): 
                        ...
                        if (g is not None): 
                            return AddressItemToken._new82(AddressItemToken.ItemType.CITY, t, tok.end_token, g)
                        break
            ...
            if (isinstance(tok.termin.tag, AddressItemToken.ItemType)): 
                ...
                if (typ_ == AddressItemToken.ItemType.PREFIX): 
                    ...
                    if (rt is not None): 
                        return AddressItemToken._new93(typ_, t, rt.end_token, rt)
                    ...
                    if (t1 is not None and ((t1.morph.class0_.is_preposition or t1.morph.class0_.is_conjunction)) and (t1.whitespaces_after_count < 2)): 
                        ...
                        if (tok2 is not None and (isinstance(tok2.termin.tag, AddressItemToken.ItemType))): 
                            ...
                            if (typ2 != typ_ and ((typ2 == AddressItemToken.ItemType.PLOT or ((typ2 == AddressItemToken.ItemType.HOUSE and typ_ == AddressItemToken.ItemType.PLOT))))): 
                                ...
                                if (t1 is None): 
                                    return AddressItemToken._new94(typ_, t, tok2.end_token, "0", house_typ)
                if (typ_ != AddressItemToken.ItemType.NUMBER): 
                    if (t1 is None and t.length_char > 1): 
                        return AddressItemToken._new95(typ_, t, tok.end_token, house_typ, build_typ)
                    if ((isinstance(t1, NumberToken)) and (t1).value == "0"): 
                        return AddressItemToken._new96(typ_, t, t1, "0", house_typ, build_typ)
        ...
        if (tok is not None and (isinstance(tok.termin.tag, AddressItemToken.ItemType)) and (Utils.valToEnum(tok.termin.tag, AddressItemToken.ItemType)) == AddressItemToken.ItemType.NUMBER): 
            ...
            re0 = AddressItemToken._new96(typ_, t, tok.end_token, "0", house_typ, build_typ)
            ...
            if ((re11) is not None): 
                ...
                if ((isinstance(t1, TextToken)) and ((typ_ == AddressItemToken.ItemType.HOUSE or typ_ == AddressItemToken.ItemType.BUILDING or typ_ == AddressItemToken.ItemType.CORPUS))): 
                    ...
                    if (ter == "АБ" or ter == "АБВ" or ter == "МГУ"): 
                        return AddressItemToken._new96(typ_, t, t1, ter, house_typ, build_typ)
                ...
                if (typ_ == AddressItemToken.ItemType.PLOT and t1 is not None): 
                    if ((t1.isValue("ОКОЛО", None) or t1.isValue("РЯДОМ", None) or t1.isValue("НАПРОТИВ", None)) or t1.isValue("БЛИЗЬКО", None) or t1.isValue("НАВПАКИ", None)): 
                        return AddressItemToken._new83(typ_, t, t1, t1.getSourceText().lower())
                return None
        ...
        if (t1 is None): 
            ...
            while t1.next0_ is not None:
                t1 = t1.next0_
        return AddressItemToken._new104(typ_, t, t1, Utils.toStringStringIO(num), t.morph, house_typ, build_typ)
        ...
        while tt is not None: 
            if ((((tt.isValue("В", None) or tt.isValue("B", None))) and tt.next0_ is not None and tt.next0_.isCharOf("./\\")) and (isinstance(tt.next0_.next0_, TextToken)) and tt.next0_.next0_.isValue("Ч", None)): 
                ...
                if ((tt).term.startswith("ОБЩ")): 
                    ...
                    if (re is not None): 
                        return re
                    return AddressItemToken._new83(ty, t, tt, "ОБЩ")
        ...
        if (tok is None): 
            if (isinstance(tt, NumberToken)): 
                ...
                if (nex is not None and ((nex.ex_typ == NumberExType.METER or nex.ex_typ == NumberExType.KILOMETER))): 
                    ...
                    wraptyy109 = RefOutArgWrapper(tyy)
                    res.detail_meters = (math.floor(nex.normalizeValue(wraptyy109)))
            ...
            if (t.isValue("У", None)): 
                if (MiscLocationHelper.checkGeoObjectBefore(t)): 
                    ...
                    return None
            res = AddressItemToken._new110(AddressItemToken.ItemType.DETAIL, t, tok.end_token, Utils.valToEnum(tok.termin.tag, AddressDetailType))
        ...
        while True:
            ...
            if ((isinstance(tt, NumberToken)) and tt.next0_ is not None): 
                ...
                if (nex is not None and ((nex.ex_typ == NumberExType.METER or nex.ex_typ == NumberExType.KILOMETER))): 
                    ...
                    res.detail_meters = (math.floor(nex.normalizeValue(wraptyy111)))
    ...
    def tryAttachOrg(t : 'Token') -> 'AddressItemToken':
                ...
                while i < len(namm): 
                    if (str.islower(namm[i]) and i > 2): 
                        ...
                        if (li is not None and len(li) > 0): 
                            ...
                            return AddressItemToken._new113(AddressItemToken.ItemType.STREET, t, rt00.end_token, rt00.referent, rt00, True)
                        break
                    i += 1
        ...
        if (typ_ is not None): 
            ...
            rt = ReferentToken._new114(org0_, t, t1, t.kit.getAnalyzerDataByAnalyzerName("ORGANIZATION"))
            empty_org = False
        ...
        if (rt.referent.findSlot("TYPE", "администрация", True) is not None or rt.referent.findSlot("TYPE", "адміністрація", True) is not None): 
            ...
            if (ge is not None): 
                return AddressItemToken._new82((AddressItemToken.ItemType.REGION if ge.is_region else AddressItemToken.ItemType.CITY), t, rt.end_token, ge)
        res = AddressItemToken._new113(AddressItemToken.ItemType.STREET, t, rt.end_token, rt.referent, rt, typ_ is not None)
        return res
    ...
    def initialize() -> None:
        ...
        t = Termin._new117("ДОМ", AddressItemToken.ItemType.HOUSE)
        t.addAbridge("Д.")
        t.addVariant("КОТТЕДЖ", False)
        t.addAbridge("КОТ.")
        t.addVariant("ДАЧА", False)
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new118("БУДИНОК", AddressItemToken.ItemType.HOUSE, MorphLang.UA)
        t.addAbridge("Б.")
        t.addVariant("КОТЕДЖ", False)
        t.addAbridge("БУД.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new119("ВЛАДЕНИЕ", AddressItemToken.ItemType.HOUSE, AddressHouseType.ESTATE)
        t.addAbridge("ВЛАД.")
        t.addAbridge("ВЛД.")
        t.addAbridge("ВЛ.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new119("ДОМОВЛАДЕНИЕ", AddressItemToken.ItemType.HOUSE, AddressHouseType.HOUSEESTATE)
        ...
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("ПОДЪЕЗД ДОМА", AddressItemToken.ItemType.HOUSE)
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("ПОДВАЛ ДОМА", AddressItemToken.ItemType.HOUSE)
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("КРЫША ДОМА", AddressItemToken.ItemType.HOUSE)
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("ЭТАЖ", AddressItemToken.ItemType.FLOOR)
        t.addAbridge("ЭТ.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("ПОДЪЕЗД", AddressItemToken.ItemType.POTCH)
        t.addAbridge("ПОД.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("КОРПУС", AddressItemToken.ItemType.CORPUS)
        t.addAbridge("КОРП.")
        t.addAbridge("КОР.")
        t.addAbridge("Д.КОРП.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("К", AddressItemToken.ItemType.CORPUSORFLAT)
        t.addAbridge("К.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("СТРОЕНИЕ", AddressItemToken.ItemType.BUILDING)
        t.addAbridge("СТРОЕН.")
        t.addAbridge("СТР.")
        t.addAbridge("СТ.")
        ...
        t.addAbridge("Д.СТР.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new119("СООРУЖЕНИЕ", AddressItemToken.ItemType.BUILDING, AddressBuildingType.CONSTRUCTION)
        t.addAbridge("СООР.")
        t.addAbridge("СООРУЖ.")
        t.addAbridge("СООРУЖЕН.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new119("ЛИТЕРА", AddressItemToken.ItemType.BUILDING, AddressBuildingType.LITER)
        t.addAbridge("ЛИТ.")
        t.addVariant("ЛИТЕР", False)
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("УЧАСТОК", AddressItemToken.ItemType.PLOT)
        t.addAbridge("УЧАСТ.")
        t.addAbridge("УЧ.")
        t.addAbridge("УЧ-К")
        ...
        t.addAbridge("ПОЗ.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("КВАРТИРА", AddressItemToken.ItemType.FLAT)
        t.addAbridge("КВАРТ.")
        t.addAbridge("КВАР.")
        t.addAbridge("КВ.")
        t.addAbridge("КВ-РА")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("ОФИС", AddressItemToken.ItemType.OFFICE)
        t.addAbridge("ОФ.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new118("ОФІС", AddressItemToken.ItemType.OFFICE, MorphLang.UA)
        t.addAbridge("ОФ.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("БИЗНЕС-ЦЕНТР", AddressItemToken.ItemType.BUSINESSCENTER)
        t.acronym = "БЦ"
        t.addVariant("БИЗНЕС ЦЕНТР", False)
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("БЛОК", AddressItemToken.ItemType.BLOCK)
        ...
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("БОКС", AddressItemToken.ItemType.BOX)
        ...
        t.addAbridge("Г.Б.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("КОМНАТА", AddressItemToken.ItemType.OFFICE)
        t.addAbridge("КОМ.")
        t.addAbridge("КОМН.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("КАБИНЕТ", AddressItemToken.ItemType.OFFICE)
        t.addAbridge("КАБ.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("НОМЕР", AddressItemToken.ItemType.NUMBER)
        t.addAbridge("НОМ.")
        t.addAbridge("№")
        t.addAbridge("N")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new141("БЕЗ НОМЕРА", "Б/Н", AddressItemToken.ItemType.NONUMBER)
        t.addAbridge("Б.Н.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("АБОНЕНТСКИЙ ЯЩИК", AddressItemToken.ItemType.POSTOFFICEBOX)
        t.addAbridge("А.Я.")
        t.addVariant("ПОЧТОВЫЙ ЯЩИК", False)
        t.addAbridge("П.Я.")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new143("ГОРОДСКАЯ СЛУЖЕБНАЯ ПОЧТА", AddressItemToken.ItemType.CSP, "ГСП")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("АДРЕС", AddressItemToken.ItemType.PREFIX)
        ...
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("АДРЕСА", AddressItemToken.ItemType.PREFIX)
        ...
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("КИЛОМЕТР", AddressItemToken.ItemType.KILOMETER)
        t.addAbridge("КИЛОМ.")
        t.addAbridge("КМ.")
        AddressItemToken.M_ONTOLOGY.add(t)
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ПЕРЕСЕЧЕНИЕ", AddressDetailType.CROSS))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("НА ПЕРЕСЕЧЕНИИ", AddressDetailType.CROSS))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ПЕРЕКРЕСТОК", AddressDetailType.CROSS))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("НА ПЕРЕКРЕСТКЕ", AddressDetailType.CROSS))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("НА ТЕРРИТОРИИ", AddressDetailType.NEAR))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("СЕРЕДИНА", AddressDetailType.NEAR))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ПРИМЫКАТЬ", AddressDetailType.NEAR))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ГРАНИЧИТЬ", AddressDetailType.NEAR))
        t = Termin._new117("ВБЛИЗИ", AddressDetailType.NEAR)
        ...
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new117("РАЙОН", AddressDetailType.NEAR)
        t.addAbridge("Р-Н")
        AddressItemToken.M_ONTOLOGY.add(t)
        t = Termin._new141("В РАЙОНЕ", "РАЙОН", AddressDetailType.NEAR)
        t.addAbridge("В Р-НЕ")
        AddressItemToken.M_ONTOLOGY.add(t)
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ПРИМЕРНО", AddressDetailType.UNDEFINED))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ПОРЯДКА", AddressDetailType.UNDEFINED))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ПРИБЛИЗИТЕЛЬНО", AddressDetailType.UNDEFINED))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("НАПРАВЛЕНИЕ", AddressDetailType.UNDEFINED))
        t = Termin._new117("ОБЩЕЖИТИЕ", AddressDetailType.HOSTEL)
        t.addAbridge("ОБЩ.")
        t.addAbridge("ПОМ.ОБЩ.")
        AddressItemToken.M_ONTOLOGY.add(t)
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("СЕВЕРНЕЕ", AddressDetailType.NORTH))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("СЕВЕР", AddressDetailType.NORTH))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ЮЖНЕЕ", AddressDetailType.SOUTH))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ЮГ", AddressDetailType.SOUTH))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ЗАПАДНЕЕ", AddressDetailType.WEST))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ЗАПАД", AddressDetailType.WEST))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ВОСТОЧНЕЕ", AddressDetailType.EAST))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ВОСТОК", AddressDetailType.EAST))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("СЕВЕРО-ЗАПАДНЕЕ", AddressDetailType.NORTHWEST))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("СЕВЕРО-ЗАПАД", AddressDetailType.NORTHWEST))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("СЕВЕРО-ВОСТОЧНЕЕ", AddressDetailType.NORTHEAST))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("СЕВЕРО-ВОСТОК", AddressDetailType.NORTHEAST))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ЮГО-ЗАПАДНЕЕ", AddressDetailType.SOUTHWEST))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ЮГО-ЗАПАД", AddressDetailType.SOUTHWEST))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ЮГО-ВОСТОЧНЕЕ", AddressDetailType.SOUTHEAST))
        AddressItemToken.M_ONTOLOGY.add(Termin._new117("ЮГО-ВОСТОК", AddressDetailType.SOUTHEAST))
        t = Termin("ТАМ ЖЕ")
        t.addAbridge("ТАМЖЕ")
        AddressItemToken.M_ONTOLOGY.add(t)
        AddressItemToken.M_ORG_ONTOLOGY = TerminCollection()
        t = Termin._new112("САДОВОЕ ТОВАРИЩЕСТВО", "СТ")
        ...
        AddressItemToken.M_ORG_ONTOLOGY.add(t)
        t = Termin._new180("САДОВОДЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ОБЪЕДИНЕНИЕ", "СНО", True)
        t.addVariant("САДОВОЕ НЕКОММЕРЧЕСКОЕ ОБЪЕДИНЕНИЕ", False)
        AddressItemToken.M_ORG_ONTOLOGY.add(t)
        t = Termin._new180("САДОВОДЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ПАРТНЕРСТВО", "СНП", True)
        t.addVariant("САДОВОЕ НЕКОММЕРЧЕСКОЕ ПАРТНЕРСТВО", False)
        AddressItemToken.M_ORG_ONTOLOGY.add(t)
        t = Termin._new180("САДОВОДЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", "СНТ", True)
        t.addVariant("САДОВОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", False)
        AddressItemToken.M_ORG_ONTOLOGY.add(t)
        t = Termin._new180("НЕКОММЕРЧЕСКОЕ САДОВОДЧЕСКОЕ ТОВАРИЩЕСТВО", "НСТ", True)
        t.addVariant("НЕКОММЕРЧЕСКОЕ САДОВОЕ ТОВАРИЩЕСТВО", False)
        AddressItemToken.M_ORG_ONTOLOGY.add(t)
        t = Termin._new180("ОБЪЕДИНЕННОЕ НЕКОММЕРЧЕСКОЕ САДОВОДЧЕСКОЕ ТОВАРИЩЕСТВО", "ОНСТ", True)
        t.addVariant("ОБЪЕДИНЕННОЕ НЕКОММЕРЧЕСКОЕ САДОВОЕ ТОВАРИЩЕСТВО", False)
        AddressItemToken.M_ORG_ONTOLOGY.add(t)
        t = Termin._new180("САДОВОДЧЕСКАЯ ПОТРЕБИТЕЛЬСКАЯ КООПЕРАЦИЯ", "СПК", True)
        t.addVariant("САДОВАЯ ПОТРЕБИТЕЛЬСКАЯ КООПЕРАЦИЯ", False)
        AddressItemToken.M_ORG_ONTOLOGY.add(t)
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ДАЧНО СТРОИТЕЛЬНО ПРОИЗВОДСТВЕННЫЙ КООПЕРАТИВ", "ДСПК", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ЖИЛИЩНЫЙ СТРОИТЕЛЬНО ПРОИЗВОДСТВЕННЫЙ КООПЕРАТИВ", "ЖСПК", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ЖИЛИЩНЫЙ СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", "ЖСК", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ЖИЛИЩНЫЙ СТРОИТЕЛЬНЫЙ КООПЕРАТИВ ИНДИВИДУАЛЬНЫХ ЗАСТРОЙЩИКОВ", "ЖСКИЗ", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ОГОРОДНИЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ОБЪЕДИНЕНИЕ", "ОНО", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ОГОРОДНИЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ПАРТНЕРСТВО", "ОНП", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ОГОРОДНИЧЕСКОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО", "ОНТ", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ОГОРОДНИЧЕСКИЙ ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", "ОПК", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ТОВАРИЩЕСТВО СОБСТВЕННИКОВ НЕДВИЖИМОСТИ", "СТСН", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("САДОВОДЧЕСКОЕ ТОВАРИЩЕСТВО СОБСТВЕННИКОВ НЕДВИЖИМОСТИ", "ТСН", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ТОВАРИЩЕСТВО СОБСТВЕННИКОВ ЖИЛЬЯ", "ТСЖ", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("САДОВЫЕ ЗЕМЕЛЬНЫЕ УЧАСТКИ", "СЗУ", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ТОВАРИЩЕСТВО ИНДИВИДУАЛЬНЫХ ЗАСТРОЙЩИКОВ", "ТИЗ", True))
        t = Termin._new180("КОЛЛЕКТИВ ИНДИВИДУАЛЬНЫХ ЗАСТРОЙЩИКОВ", "КИЗ", True)
        t.addVariant("КИЗК", False)
        AddressItemToken.M_ORG_ONTOLOGY.add(t)
        t = Termin._new180("САДОВОЕ НЕКОММЕРЧЕСКОЕ ТОВАРИЩЕСТВО СОБСТВЕННИКОВ НЕДВИЖИМОСТИ", "СНТСН", True)
        ...
        t.acronym_can_be_lower = True
        AddressItemToken.M_ORG_ONTOLOGY.add(t)
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ГАРАЖНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", "ГСК", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ГАРАЖНО ЭКСПЛУАТАЦИОННЫЙ КООПЕРАТИВ", "ГЭК", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ГАРАЖНО ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", "ГПК", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ПОТРЕБИТЕЛЬСКИЙ ГАРАЖНО СТРОИТЕЛЬНЫЙ КООПЕРАТИВ", "ПГСК", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(Termin._new180("ГАРАЖНЫЙ СТРОИТЕЛЬНО ПОТРЕБИТЕЛЬСКИЙ КООПЕРАТИВ", "ГСПК", True))
        AddressItemToken.M_ORG_ONTOLOGY.add(t)
        t = Termin("САНАТОРИЙ")
        t.addAbridge("САН.")
        AddressItemToken.M_ORG_ONTOLOGY.add(t)
    ...
    @staticmethod
    def _new82(_arg1 : 'ItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'Referent') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.referent = _arg4
        return res
    
    @staticmethod
    def _new83(_arg1 : 'ItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : str) -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.value = _arg4
        return res
    
    @staticmethod
    def _new85(_arg1 : 'ItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'Referent', _arg5 : bool) -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.referent = _arg4
        res.is_doubt = _arg5
        return res
    ...
    @staticmethod
    def _new93(_arg1 : 'ItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'ReferentToken') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.ref_token = _arg4
        return res
    
    @staticmethod
    def _new94(_arg1 : 'ItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : str, _arg5 : 'AddressHouseType') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.value = _arg4
    ...
    @staticmethod
    def _new95(_arg1 : 'ItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'AddressHouseType', _arg5 : 'AddressBuildingType') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
    ...
    @staticmethod
    def _new96(_arg1 : 'ItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : str, _arg5 : 'AddressHouseType', _arg6 : 'AddressBuildingType') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.value = _arg4
        res.house_type = _arg5
    ...
    @staticmethod
    def _new104(_arg1 : 'ItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : str, _arg5 : 'MorphCollection', _arg6 : 'AddressHouseType', _arg7 : 'AddressBuildingType') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.value = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new110(_arg1 : 'ItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'AddressDetailType') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.detail_type = _arg4
        return res
    
    @staticmethod
    def _new113(_arg1 : 'ItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'Referent', _arg5 : 'ReferentToken', _arg6 : bool) -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.referent = _arg4
        res.ref_token = _arg5
