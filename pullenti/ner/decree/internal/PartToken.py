...
class PartToken(MetaToken):
    ...
    class PartValue(MetaToken):
        ...
        def int_value(self) -> int:
            if (Utils.isNullOrEmpty(self.value)): 
                return 0
            wrapnum1005 = RefOutArgWrapper(0)
            inoutres1006 = Utils.tryParseInt(self.value, wrapnum1005)
            num = wrapnum1005.value
            if (inoutres1006): 
                return num
            return 0
        ...
        def correctValue(self) -> None:
            ...
            while True:
                ...
                if ((t.is_hiphen and not t.is_whitespace_after and (isinstance(t.next0_, NumberToken))) and (t.next0_).int_value is not None): 
                    wrapn11007 = RefOutArgWrapper(0)
                    inoutres1008 = Utils.tryParseInt(self.value, wrapn11007)
                    n1 = wrapn11007.value
                    if (inoutres1008): 
    ...
    def tryAttach(t : 'Token', prev : 'PartToken', in_bracket : bool=False, ignore_number : bool=False) -> 'PartToken':
        ...
        if ((isinstance(t, NumberToken)) and t.next0_ is not None and (t.whitespaces_after_count < 3)): 
            ...
            if (re is not None): 
                ...
                if (ok1 or in_bracket): 
                    re.begin_token = t
                    re.values.append(PartToken.PartValue._new1009(t, t, str((t).value)))
                    return re
                ...
                if (t0.isChar('(') and t.next0_ is not None): 
                    if (t.next0_.isValue("ЧАСТЬ", None) or t.next0_.isValue("Ч", None)): 
                        ...
                        if (te.next0_ is not None and te.next0_.isChar('.')): 
                            te = te.next0_
                        res = PartToken._new770(t, te, PartToken.ItemType.PART)
                        res.values.append(PartToken.PartValue._new1009(t, t, str((t).value)))
                        return res
                return None
            if (dr.clause is None): 
                return None
            res = PartToken._new1012(t, t, PartToken.ItemType.CLAUSE, not delim)
            pv = PartToken.PartValue._new1009(t, t, str((t).value))
        ...
        if (((isinstance(t, NumberToken)) and (t).typ == NumberSpellingType.DIGIT and prev is not None) and prev.typ == PartToken.ItemType.PREFIX and (t.whitespaces_before_count < 3)): 
            ...
            if (ne is not None and ne.typ == DecreeToken.ItemType.TYP): 
                ...
                ok = True
            if (ok): 
                res = PartToken._new770(t, pv.end_token, PartToken.ItemType.ITEM)
                res.values.append(pv)
                return res
        if (tt is None): 
            return None
        ...
        if (res is not None): 
            ...
            if (t1.isValue("СИЛУ", None) and t1.previous is not None and t1.previous.morph.class0_.is_verb): 
                return None
            res = PartToken._new770(t1, t1, PartToken.ItemType.PREFIX)
            ...
            if (t1.next0_ is not None and t1.next0_.isValue("ПО", None)): 
                t1 = t1.next0_
            return PartToken._new770(t, t1, PartToken.ItemType.PREFIX)
            ...
            rr = PartToken._new770(t1, t1.next0_, PartToken.ItemType.PART)
            rr.values.append(PartToken.PartValue._new1009(t1, t1, ("мотивировочная" if t1.isValue("МОТИВИРОВОЧНЫЙ", None) or t1.isValue("МОТИВУВАЛЬНИЙ", None) else "резолютивная")))
            return rr
        if (res is None): 
            return None
        if (ignore_number): 
        ...
        while t1 is not None:
            ...
            if (BracketHelper.canBeStartOfSequence(t1, False, False)): 
                ...
                while True:
                    ...
                    if (isinstance(ttt, NumberToken)): 
                        ...
                        if (newp is None): 
                            newp = list()
                        newp.append(PartToken.PartValue._new1009(ttt, ttt, str((ttt).value)))
                        continue
                ...
                if (t1 is not None and t1.is_hiphen and BracketHelper.canBeStartOfSequence(t1.next0_, False, False)): 
                    ...
                    if ((br1 is not None and (isinstance(t1.next0_.next0_, TextToken)) and t1.next0_.next0_.length_char == 1) and t1.next0_.next0_.next0_ == br1.end_token): 
                        res.values.append(PartToken.PartValue._new1009(br1.begin_token, br1.end_token, (t1.next0_.next0_).term))
            ...
            if (((isinstance(t1, TextToken)) and t1.length_char == 1 and t1.chars.is_letter) and len(res.values) == 0): 
                if (t1.chars.is_all_upper and res.typ == PartToken.ItemType.SUBPROGRAM): 
                    res.values.append(PartToken.PartValue._new1009(t1, t1, (t1).term))
                    res.end_token = t1
                    return res
                ok = True
                lev = 0
                ...
                if (ok and t1.next0_ is not None and t1.next0_.isChar(')')): 
                    res.values.append(PartToken.PartValue._new1009(t1, t1.next0_, (t1).term))
                    res.end_token = t1.next0_
                    t1 = t1.next0_.next0_
                    continue
                if (((ok and t1.next0_ is not None and t1.next0_.isChar('.')) and not t1.next0_.is_whitespace_after and (isinstance(t1.next0_.next0_, NumberToken))) and t1.next0_.next0_.next0_ is not None and t1.next0_.next0_.next0_.isChar(')')): 
                    res.values.append(PartToken.PartValue._new1009(t1, t1.next0_.next0_.next0_, "{0}.{1}".format((t1).term, (t1.next0_.next0_).value)))
            ...
            if (isinstance(t1, NumberToken)): 
                ...
                if (len(res.values) > 0): 
                    ...
                    if ((t1).typ != ntyp): 
                        break
                ntyp = (t1).typ
                val = PartToken.PartValue._new1009(tt0, t1, str((t1).value))
                val.correctValue()
    ...
    def __createPartTyp0(t1 : 'Token', prev : 'PartToken') -> 'PartToken':
        wrapis_short1031 = RefOutArgWrapper(False)
        pt = PartToken.__createPartTyp(t1, prev, wrapis_short1031)
        is_short = wrapis_short1031.value
        if (pt is None): 
            return None
    ...
    def __createPartTyp(t1 : 'Token', prev : 'PartToken', is_short : bool) -> 'PartToken':
        ...
        if (t1.isValue("ЧАСТЬ", "ЧАСТИНА")): 
            return PartToken._new770(t1, t1, PartToken.ItemType.PART)
        if (t1.isValue("Ч", None)): 
            is_short.value = True
            return PartToken._new770(t1, t1, PartToken.ItemType.PART)
        if (t1.isValue("ГЛАВА", None) or t1.isValue("ГЛ", None)): 
            is_short.value = t1.length_char == 2
            return PartToken._new770(t1, t1, PartToken.ItemType.CHAPTER)
        if (t1.isValue("ПРИЛОЖЕНИЕ", "ДОДАТОК") or t1.isValue("ПРИЛ", None)): 
            ...
            return PartToken._new770(t1, t1, PartToken.ItemType.APPENDIX)
        if (t1.isValue("ПРИМЕЧАНИЕ", "ПРИМІТКА") or t1.isValue("ПРИМ", None)): 
            is_short.value = (t1.length_char < 5)
            return PartToken._new770(t1, t1, PartToken.ItemType.NOTICE)
        if (t1.isValue("СТАТЬЯ", "СТАТТЯ") or t1.isValue("СТ", None)): 
            is_short.value = (t1.length_char < 3)
            return PartToken._new770(t1, t1, PartToken.ItemType.CLAUSE)
        if (t1.isValue("ПУНКТ", None) or t1.isValue("П", None) or t1.isValue("ПП", None)): 
            is_short.value = (t1.length_char < 3)
            return PartToken._new1038(t1, t1, PartToken.ItemType.ITEM, (PartToken.ItemType.SUBITEM if t1.isValue("ПП", None) else PartToken.ItemType.UNDEFINED))
        if (t1.isValue("ПОДПУНКТ", "ПІДПУНКТ")): 
            return PartToken._new770(t1, t1, PartToken.ItemType.SUBITEM)
        if (t1.isValue("ПРЕАМБУЛА", None)): 
            return PartToken._new770(t1, t1, PartToken.ItemType.PREAMBLE)
        if (t1.isValue("ПОДП", None) or t1.isValue("ПІДП", None)): 
            is_short.value = True
            return PartToken._new770(t1, t1, PartToken.ItemType.SUBITEM)
        if (t1.isValue("РАЗДЕЛ", "РОЗДІЛ") or t1.isValue("РАЗД", None)): 
            is_short.value = (t1.length_char < 5)
            return PartToken._new770(t1, t1, PartToken.ItemType.SECTION)
        if (((t1.isValue("Р", None) or t1.isValue("P", None))) and t1.next0_ is not None and t1.next0_.isChar('.')): 
            if (prev is not None): 
                if (prev.typ == PartToken.ItemType.ITEM or prev.typ == PartToken.ItemType.SUBITEM): 
                    is_short.value = True
                    return PartToken._new770(t1, t1.next0_, PartToken.ItemType.SECTION)
        if (t1.isValue("ПОДРАЗДЕЛ", "ПІРОЗДІЛ")): 
            return PartToken._new770(t1, t1, PartToken.ItemType.SUBSECTION)
        if (t1.isValue("ПАРАГРАФ", None) or t1.isValue("§", None)): 
            return PartToken._new770(t1, t1, PartToken.ItemType.PARAGRAPH)
        if (t1.isValue("АБЗАЦ", None) or t1.isValue("АБЗ", None)): 
            is_short.value = (t1.length_char < 7)
            return PartToken._new770(t1, t1, PartToken.ItemType.INDENTION)
        if (t1.isValue("СТРАНИЦА", "СТОРІНКА") or t1.isValue("СТР", "СТОР")): 
            is_short.value = (t1.length_char < 7)
            return PartToken._new770(t1, t1, PartToken.ItemType.PAGE)
        if (t1.isValue("ПОДАБЗАЦ", "ПІДАБЗАЦ") or t1.isValue("ПОДАБЗ", "ПІДАБЗ")): 
            return PartToken._new770(t1, t1, PartToken.ItemType.SUBINDENTION)
        if (t1.isValue("ПОДПАРАГРАФ", "ПІДПАРАГРАФ")): 
            return PartToken._new770(t1, t1, PartToken.ItemType.SUBPARAGRAPH)
        if (t1.isValue("ПОДПРОГРАММА", "ПІДПРОГРАМА")): 
            return PartToken._new770(t1, t1, PartToken.ItemType.SUBPROGRAM)
        if (t1.isValue("ДОПСОГЛАШЕНИЕ", None)): 
            return PartToken._new770(t1, t1, PartToken.ItemType.ADDAGREE)
        if (((t1.isValue("ДОП", None) or t1.isValue("ДОПОЛНИТЕЛЬНЫЙ", "ДОДАТКОВА"))) and t1.next0_ is not None): 
            ...
            if (tt.isValue("СОГЛАШЕНИЕ", "УГОДА")): 
                return PartToken._new770(t1, tt, PartToken.ItemType.ADDAGREE)
        return None
    ...
    def tryAttachList(t : 'Token', in_bracket : bool=False, max_count : int=40) -> typing.List['PartToken']:
                            ...
                            if (li[len(li) - 1].end_token.next0_ == br.end_token): 
                                if (len(p.values) > 1): 
                                    ...
                                    while ii < len(p.values): 
                                        pp = PartToken._new770(p.values[ii].begin_token, (p.end_token if ii == (len(p.values) - 1) else p.values[ii].end_token), p.typ)
            ...
            if (p0 is None): 
                ...
                if ((isinstance(tt, NumberToken)) and delim): 
                    ...
                    if (p.typ == PartToken.ItemType.CLAUSE or in_bracket): 
                        p0 = PartToken._new770(tt, tt, PartToken.ItemType.CLAUSE)
                        ...
                        p0 = PartToken._new770(tt, tt, res[len(res) - 1].typ)
                    if (p0 is None): 
                        break
                    vv = PartToken.PartValue._new1009(tt, tt, str((tt).value))
                    p0.values.append(vv)
                    vv.correctValue()
        ...
        while True:
            ...
            if (res[i].typ == PartToken.ItemType.PART and res[i + 1].typ == PartToken.ItemType.PART and len(res[i].values) > 1): 
                ...
                if ((v2 - v1) < 10): 
                    continue
                pt = PartToken._new770(res[i].end_token, res[i].end_token, PartToken.ItemType.CLAUSE)
    ...
    def getNumber(str0_ : str) -> int:
        if (Utils.isNullOrEmpty(str0_)): 
            return 0
        wrapi1066 = RefOutArgWrapper(0)
        inoutres1067 = Utils.tryParseInt(str0_, wrapi1066)
        i = wrapi1066.value
        if (inoutres1067): 
            return i
        ...
        if ((ord(ch)) < 0x80): 
            ...
            if ((ch == 'Z' and len(str0_) > 2 and str0_[1] == '.') and str.isdigit(str0_[2])): 
                wrapn1062 = RefOutArgWrapper(0)
                inoutres1063 = Utils.tryParseInt(str0_[2:], wrapn1062)
                n = wrapn1062.value
                if (inoutres1063): 
                    i += n
            ...
            if ((ch == 'Я' and len(str0_) > 2 and str0_[1] == '.') and str.isdigit(str0_[2])): 
                wrapn1064 = RefOutArgWrapper(0)
                inoutres1065 = Utils.tryParseInt(str0_[2:], wrapn1064)
                n = wrapn1064.value
                if (inoutres1065): 
                    i += n
        if (i < 0): 
    ...
    @staticmethod
    def _new770(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType') -> 'PartToken':
    ...
    @staticmethod
    def _new1038(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'ItemType') -> 'PartToken':
        res = PartToken(_arg1, _arg2)
        res.typ = _arg3
        res.alt_typ = _arg4
        return res