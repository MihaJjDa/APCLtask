...
class CanonicDecreeRefUri:
    ...
    @staticmethod
    def _new806(_arg1 : str, _arg2 : 'Referent', _arg3 : int, _arg4 : int) -> 'CanonicDecreeRefUri':
    ...
    @staticmethod
    def _new808(_arg1 : str, _arg2 : 'Referent', _arg3 : int, _arg4 : int, _arg5 : bool) -> 'CanonicDecreeRefUri':
        res = CanonicDecreeRefUri(_arg1)
        res.ref = _arg2
        res.begin_char = _arg3
        res.end_char = _arg4
