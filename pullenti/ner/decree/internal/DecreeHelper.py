    ...
    def tryCreateCanonicDecreeRefUri(t : 'Token') -> 'CanonicDecreeRefUri':
        ...
        if (dr is not None): 
            if (dr.kind == DecreeKind.PUBLISHER): 
                return None
            res = CanonicDecreeRefUri._new806(t.kit.sofa.text, dr, t.begin_char, t.end_char)
            ...
            if (rt.begin_token.isChar('(') and rt.end_token.isChar(')')): 
                res = CanonicDecreeRefUri._new806(t.kit.sofa.text, dr, rt.begin_token.next0_.begin_char, rt.end_token.previous.end_char)
                return res
        ...
        res = CanonicDecreeRefUri._new808(t.kit.sofa.text, dpr, t.begin_char, t1.end_char, has_diap)
