...
class NamedItemToken(MetaToken):
    ...
    def tryParse(t : 'Token', loc_onto : 'IntOntologyCollection') -> 'NamedItemToken':
        ...
        if (typ is not None): 
            if (not ((isinstance(t, TextToken)))): 
                return None
            res = NamedItemToken._new1636(typ.begin_token, typ.end_token, typ.morph, typ.chars)
        ...
        if (nam is not None): 
            if (nam.begin_token.chars.is_all_lower): 
                return None
            res = NamedItemToken._new1636(nam.begin_token, nam.end_token, nam.morph, nam.chars)
        ...
        if (adj is not None): 
            ...
            if ((isinstance(adj.end_token.next0_, ReferentToken)) and (isinstance(adj.end_token.next0_.getReferent(), GeoReferent))): 
                re = NamedItemToken._new1638(t, adj.end_token.next0_, adj.end_token.next0_.morph)
                re.kind = NamedEntityKind.LOCATION
    ...
    def _initialize() -> None:
        ...
        for s in ["КРЕМЛЬ", "КАПИТОЛИЙ", "БЕЛЫЙ ДОМ"]: 
            ...
            t.tag = NamedEntityKind.BUILDING
            NamedItemToken.__m_names.add(t)
        t = Termin._new117("МЕЖДУНАРОДНАЯ КОСМИЧЕСКАЯ СТАНЦИЯ", NamedEntityKind.BUILDING)
        t.acronym = "МКС"
        NamedItemToken.__m_names.add(t)
    ...
    @staticmethod
    def _new1635(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Referent', _arg4 : 'MorphCollection') -> 'NamedItemToken':
    ...
    @staticmethod
    def _new1636(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'MorphCollection', _arg4 : 'CharsInfo') -> 'NamedItemToken':
        res = NamedItemToken(_arg1, _arg2)
        res.morph = _arg3
        res.chars = _arg4
        return res
    ...
    @staticmethod
    def _new1638(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'MorphCollection') -> 'NamedItemToken':
        res = NamedItemToken(_arg1, _arg2)
        res.morph = _arg3
        return res