...
class PersonIdentityToken(MetaToken):
            ...
            for ot in otl: 
                if (ot.end_token == pits[ind].end_token): 
                    ...
                    if (inf.gender == MorphGender.MASCULINE): 
                        ...
                        if (pers.is_male): 
                            continue
                    inf0 = MorphBaseInfo._new2334(inf.case_, inf.gender)
    ...
    def tryAttachForExtOnto(pits : typing.List['PersonItemToken']) -> typing.List['PersonIdentityToken']:
        ...
        if (len(pits) == 3): 
            if (pits[0].typ == PersonItemToken.ItemType.VALUE and pits[1].typ == PersonItemToken.ItemType.INITIAL and pits[2].typ == PersonItemToken.ItemType.VALUE): 
                pit = PersonIdentityToken._new2335(pits[0].begin_token, pits[2].end_token, FioTemplateType.NAMEISURNAME)
                ...
                if (pits[0].firstname is None and pits[1].middlename is None and ((pits[1].firstname is not None or pits[2].middlename is not None))): 
                    ...
                    ok = True
                if (ok): 
                    pit = PersonIdentityToken._new2335(pits[0].begin_token, pits[2].end_token, FioTemplateType.SURNAMENAMESECNAME)
            ...
            for i in range(2):
                if (((pits[i].firstname is not None and pits[i].firstname.is_in_dictionary)) or ((pits[i ^ 1].lastname is not None and ((pits[i ^ 1].lastname.is_in_dictionary or pits[i ^ 1].lastname.is_lastname_has_std_tail))))): 
                    ...
                    break
            if (nam is not None): 
                pit = PersonIdentityToken._new2335(pits[0].begin_token, pits[1].end_token, (FioTemplateType.NAMESURNAME if nam == pits[0] else FioTemplateType.SURNAMENAME))
    ...
    def __tryAttachNameSurname(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo', prev_has_this_typ : bool=False, is_attr_before : bool=False) -> 'PersonIdentityToken':
        ...
        if (PersonIdentityToken.__isBothSurnames(pits[ind], pits[ind + 1])): 
            return None
        res = PersonIdentityToken._new2335(pits[ind].begin_token, pits[ind + 1].end_token, FioTemplateType.NAMESURNAME)
        res.coef -= (ind)
        ...
        if (not pits[ind].chars.is_latin_letter): 
            ...
            if (npt is not None and npt.end_char >= pits[ind + 1].begin_char): 
                if (pits[ind].begin_token.getMorphClassInDictionary().is_adjective): 
                    res.coef -= (2)
                elif (pits[ind + 1].begin_token.getMorphClassInDictionary().is_noun): 
                    res.coef -= (2)
        ...
        if (ind > 0 and res.coef > 0 and pits[ind].is_hiphen_before): 
            ...
            if (b1 is not None and b1.second_count == b1.pair_count): 
                res0 = PersonIdentityToken._new2335(pits[ind].begin_token, pits[ind + 1].end_token, FioTemplateType.NAMESURNAME)
    ...
    def __tryAttachSurnameName(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo', prev_has_this_typ : bool=False) -> 'PersonIdentityToken':
        ...
        if (PersonIdentityToken.__isBothSurnames(pits[ind], pits[ind + 1])): 
            return None
        res = PersonIdentityToken._new2335(pits[ind].begin_token, pits[ind + 1].end_token, FioTemplateType.SURNAMENAME)
        res.coef -= (ind)
        if (pits[ind].is_newline_after): 
            res.coef -= 1
        ...
        if (pits[0].lastname is None or not pits[0].lastname.is_lastname_has_std_tail): 
            ...
            if (stat is not None and stata is not None and statb is not None): 
                if (stat.like_chars_after_words is not None and stat.like_chars_before_words is not None): 
                    coua = 0
                    coub = 0
                    wrapcoua2342 = RefOutArgWrapper(0)
                    Utils.tryGetValue(stat.like_chars_after_words, stata, wrapcoua2342)
                    coua = wrapcoua2342.value
                    wrapcoub2341 = RefOutArgWrapper(0)
                    Utils.tryGetValue(stat.like_chars_before_words, statb, wrapcoub2341)
                    coub = wrapcoub2341.value
    ...
    def __tryAttachSurnameNameSecname(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo', prev_has_this_typ : bool=False, always : bool=False) -> 'PersonIdentityToken':
        ...
        if (not always): 
            if (PersonIdentityToken.__isBothSurnames(pits[ind], pits[ind + 2]) or PersonIdentityToken.__isBothSurnames(pits[ind], pits[ind + 1])): 
                return None
        res = PersonIdentityToken._new2335(pits[ind].begin_token, pits[ind + 2].end_token, FioTemplateType.SURNAMENAMESECNAME)
    ...
    def __tryAttachSurnameII(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo') -> 'PersonIdentityToken':
        ...
        if (pits[ind].lastname is None): 
            return None
        res = PersonIdentityToken._new2335(pits[ind].begin_token, pits[ind + 1].end_token, FioTemplateType.SURNAMEI)
        res.coef -= (ind)
        PersonIdentityToken.manageLastname(res, pits[ind], inf)
    ...
    def __tryAttachIISurname(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo') -> 'PersonIdentityToken':
        ...
        if (pits[ind].is_newline_after): 
            return None
        res = PersonIdentityToken._new2335(pits[ind].begin_token, pits[ind + 1].end_token, FioTemplateType.ISURNAME)
        res.coef -= (ind)
        res.firstname = PersonMorphCollection()
    ...
    def __tryAttachKing(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo', prev_has_this_typ : bool=False) -> 'PersonIdentityToken':
        ...
        if (num < 1): 
            ...
            if (not ok): 
                return None
        res = PersonIdentityToken._new2335(pits[0].begin_token, pits[0].end_token, FioTemplateType.KING)
    ...
    def __tryAttachAsian(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo', cou : int, prev_has_this_typ : bool=False) -> 'PersonIdentityToken':
        ...
        res = PersonIdentityToken._new2335(pits[0].begin_token, pits[cou].end_token, FioTemplateType.ASIANNAME)
        ...
        for i in range(2):
            ...
            if (not cas.is_undefined): 
                if (inf is not None and not inf.case_.is_undefined and not ((inf.case_) & cas).is_undefined): 
                    cas &= inf.case_
                res.addItem(MorphBaseInfo._new2348(g, cas))
    ...
    def checkLatinAfter(pit : 'PersonIdentityToken') -> 'PersonIdentityToken':
        ...
        if (nam is None or sur is None): 
            return None
        res = PersonIdentityToken._new2335(t, et, pit.typ)
        res.lastname = PersonMorphCollection()
    ...
    @staticmethod
    def _new2335(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'FioTemplateType') -> 'PersonIdentityToken':
