...
class PersonAttrToken(ReferentToken):
    ...
    def initialize() -> None:
        ...
        PersonAttrToken.M_TERMINS.add(PersonAttrTermin._new2244("ТОВАРИЩ", PersonAttrTerminType.PREFIX))
        PersonAttrToken.M_TERMINS.add(PersonAttrTermin._new2245("ТОВАРИШ", MorphLang.UA, PersonAttrTerminType.PREFIX))
        for s in ["ГОСПОДИН", "ГРАЖДАНИН", "УРОЖЕНЕЦ", "МИСТЕР", "СЭР", "СЕНЬОР", "МОНСЕНЬОР", "СИНЬОР", "МЕСЬЕ", "МСЬЕ", "ДОН", "МАЭСТРО", "МЭТР"]: 
            t = PersonAttrTermin._new2246(s, PersonAttrTerminType.PREFIX, MorphGender.MASCULINE)
            if (s == "ГРАЖДАНИН"): 
                t.addAbridge("ГР.")
                t.addAbridge("ГРАЖД.")
                t.addAbridge("ГР-Н")
        ...
        for s in ["ПАН", "ГРОМАДЯНИН", "УРОДЖЕНЕЦЬ", "МІСТЕР", "СЕР", "СЕНЬЙОР", "МОНСЕНЬЙОР", "МЕСЬЄ", "МЕТР", "МАЕСТРО"]: 
            t = PersonAttrTermin._new2247(s, MorphLang.UA, PersonAttrTerminType.PREFIX, MorphGender.MASCULINE)
            if (s == "ГРОМАДЯНИН"): 
                t.addAbridge("ГР.")
                t.addAbridge("ГР-Н")
            PersonAttrToken.M_TERMINS.add(t)
        for s in ["ГОСПОЖА", "ПАНИ", "ГРАЖДАНКА", "УРОЖЕНКА", "СЕНЬОРА", "СЕНЬОРИТА", "СИНЬОРА", "СИНЬОРИТА", "МИСС", "МИССИС", "МАДАМ", "МАДЕМУАЗЕЛЬ", "ФРАУ", "ФРОЙЛЯЙН", "ЛЕДИ", "ДОННА"]: 
            t = PersonAttrTermin._new2246(s, PersonAttrTerminType.PREFIX, MorphGender.FEMINIE)
            if (s == "ГРАЖДАНКА"): 
                t.addAbridge("ГР.")
                t.addAbridge("ГРАЖД.")
                t.addAbridge("ГР-КА")
        ...
        for s in ["ПАНІ", "ГРОМАДЯНКА", "УРОДЖЕНКА", "СЕНЬЙОРА", "СЕНЬЙОРА", "МІС", "МІСІС", "МАДАМ", "МАДЕМУАЗЕЛЬ", "ФРАУ", "ФРОЙЛЯЙН", "ЛЕДІ"]: 
            t = PersonAttrTermin._new2247(s, MorphLang.UA, PersonAttrTerminType.PREFIX, MorphGender.FEMINIE)
            if (s == "ГРОМАДЯНКА"): 
                t.addAbridge("ГР.")
                t.addAbridge("ГР-КА")
            PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2247("MISTER", MorphLang.EN, PersonAttrTerminType.PREFIX, MorphGender.MASCULINE)
        t.addAbridge("MR")
        t.addAbridge("MR.")
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2247("MISSIS", MorphLang.EN, PersonAttrTerminType.PREFIX, MorphGender.FEMINIE)
        t.addAbridge("MRS")
        t.addAbridge("MSR.")
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2247("MISS", MorphLang.EN, PersonAttrTerminType.PREFIX, MorphGender.FEMINIE)
        t.addAbridge("MS")
        t.addAbridge("MS.")
        PersonAttrToken.M_TERMINS.add(t)
        ...
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2245("БЕЗРОБІТНИЙ", MorphLang.UA, PersonAttrTerminType.POSITION)
        ...
        t.addAbridge("ЗАМ.")
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2256("ЗАСТУПНИК", MorphLang.UA, "заступник", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION)
        ...
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2256("УПОВНОВАЖЕНИЙ", MorphLang.UA, "уповноважений", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION)
        PersonAttrToken.M_TERMINS.add(t)
        ...
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2256("ЕКС-УПОВНОВАЖЕНИЙ", MorphLang.UA, "екс-уповноважений", PersonAttrTerminType2.IO2, PersonAttrTerminType.POSITION)
        PersonAttrToken.M_TERMINS.add(t)
        ...
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2262("ВИКОНУЮЧИЙ ОБОВЯЗКИ", MorphLang.UA, PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION)
        t.addAbridge("В.О.")
        t.acronym = "ВО"
        t.canonic_text = t.acronym
        PersonAttrToken.M_TERMINS.add(t)
        ...
        t.addAbridge("ЗАВ.")
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2245("ЗАВІДУВАЧ", MorphLang.UA, PersonAttrTerminType.POSITION)
        t.addAbridge("ЗАВІД.")
        t.addAbridge("ЗАВ.")
        PersonAttrToken.M_TERMINS.add(t)
        ...
        t.addAbridge("СОТР.")
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2245("СПІВРОБІТНИК", MorphLang.UA, PersonAttrTerminType.POSITION)
        ...
        t.addAbridge("АКАД.")
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2245("АКАДЕМІК", MorphLang.UA, PersonAttrTerminType.POSITION)
        t.addAbridge("АКАД.")
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2244("ЧЛЕН-КОРРЕСПОНДЕНТ", PersonAttrTerminType.POSITION)
        t.addAbridge("ЧЛ.-КОРР.")
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2245("ЧЛЕН-КОРЕСПОНДЕНТ", MorphLang.UA, PersonAttrTerminType.POSITION)
        t.addAbridge("ЧЛ.-КОР.")
        PersonAttrToken.M_TERMINS.add(t)
        ...
        t.addAbridge("ПРОФ.")
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2245("ПРОФЕСОР", MorphLang.UA, PersonAttrTerminType.POSITION)
        t.addAbridge("ПРОФ.")
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2245("PROFESSOR", MorphLang.EN, PersonAttrTerminType.POSITION)
        t.addAbridge("PROF.")
        PersonAttrToken.M_TERMINS.add(t)
        ...
        t.addAbridge("Д.")
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2245("DOCTOR", MorphLang.EN, PersonAttrTerminType.PREFIX)
        t.addAbridge("DR")
        t.addAbridge("DR.")
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2244("ДОКТОРАНТ", PersonAttrTerminType.POSITION)
        PersonAttrToken.M_TERMINS.add(t)
        t = PersonAttrTermin._new2245("ДОКТОРАНТ", MorphLang.UA, PersonAttrTerminType.POSITION)
        PersonAttrToken.M_TERMINS.add(t)
        ...
        for s in ["ГОЛОВНИЙ", "МОЛОДШИЙ", "СТАРШИЙ", "ПРОВІДНИЙ", "НАУКОВИЙ"]: 
            t = PersonAttrTermin._new2283(s, PersonAttrTerminType2.ADJ, PersonAttrTerminType.POSITION, MorphLang.UA)
            t.addAllAbridges(0, 0, 2)
            PersonAttrToken.M_TERMINS.add(t)
        ...
        for s in ["НИНІШНІЙ", "НОВИЙ"]: 
            t = PersonAttrTermin._new2283(s, PersonAttrTerminType2.IGNOREDADJ, PersonAttrTerminType.POSITION, MorphLang.UA)
            PersonAttrToken.M_TERMINS.add(t)
        ...
        for s in ["ТОДІШНІЙ", "КОЛИШНІЙ"]: 
            t = PersonAttrTermin._new2283(s, PersonAttrTerminType2.IO, PersonAttrTerminType.POSITION, MorphLang.UA)
            PersonAttrToken.M_TERMINS.add(t)
    ...
    def __loadAttrs(termins : 'TerminCollection', dat : bytearray, lang : 'MorphLang') -> None:
        ...
        with io.BytesIO(PersonAttrToken.__deflate(dat)) as tmp: 
            ...
            for x in xml0_.getroot(): 
                ...
                if (val == "ОТЕЦ"): 
                    pass
                pat = PersonAttrTermin._new2288(val, PersonAttrTerminType.POSITION, lang)
                for ch in attrs: 
                    if (ch == 'p'): 
    ...
    def tryAttach(t : 'Token', loc_onto : 'IntOntologyCollection', attrs : 'PersonAttrAttachAttrs'=PersonAttrAttachAttrs.NO) -> 'PersonAttrToken':
        ...
        olev = None
        lev = 0
        wrapolev2292 = RefOutArgWrapper(None)
        inoutres2293 = Utils.tryGetValue(t.kit.misc_data, "pat", wrapolev2292)
        ...
        if (res is None): 
            if (t.morph.class0_.is_noun): 
                ...
                if (aterr is not None): 
                    ...
                    if (rt is not None): 
                        res = PersonAttrToken._new2289(rt.begin_token, rt.end_token, rt.morph)
            ...
            if (((((isinstance(t, TextToken))) and (t).term == "АК" and t.next0_ is not None) and t.next0_.isChar('.') and t.next0_.next0_ is not None) and not t.next0_.next0_.chars.is_all_lower): 
                res = PersonAttrToken._new2290(t, t.next0_, PersonAttrTerminType.POSITION)
                res.prop_ref = PersonPropertyReferent._new2291("академик")
                return res
    ...
    def __TryAttach(t : 'Token', loc_onto : 'IntOntologyCollection', attrs : 'PersonAttrAttachAttrs') -> 'PersonAttrToken':
        ...
        if (nta is not None): 
            if (nta.morph.class0_.is_adjective or ((t.previous is not None and t.previous.is_comma)) or ((nta.end_token.next0_ is not None and nta.end_token.next0_.isCharOf(",.")))): 
                return PersonAttrToken._new2294(t, nta.end_token, PersonAttrTerminType.OTHER, str(nta.value), nta.morph)
        if (t.is_newline_before): 
            li = MailLine.parse(t, 0)
            if (li is not None and li.typ == MailLine.Types.BESTREGARDS): 
                return PersonAttrToken._new2296(li.begin_token, li.end_token, PersonAttrTerminType.BESTREGARDS, MorphCollection._new2295(MorphCase.NOMINATIVE))
        ...
        if ((tt.term == "Г" or tt.term == "ГР" or tt.term == "М") or tt.term == "Д"): 
            if (tt.next0_ is not None and tt.next0_.is_hiphen and (isinstance(tt.next0_.next0_, TextToken))): 
                ...
                if (vars0_ is not None): 
                    res = PersonAttrToken._new2290(tt, tt.next0_.next0_, PersonAttrTerminType.PREFIX)
                    for v in vars0_: 
                        res.morph.addItem(v)
        ...
        if (tt.term == "ГР" or tt.term == "ГРАЖД"): 
            ...
            if (isinstance(t1.next0_, NumberToken)): 
                return None
            return PersonAttrToken._new2298(tt, t1, PersonAttrTerminType.PREFIX, ("ГРОМАДЯНИН" if tt.morph.language.is_ua else "ГРАЖДАНИН"))
        npt0 = None
        step = 0
        while step < 2: 
            ...
            if (toks is None and t.isValue("ВРИО", None)): 
                toks = list()
                toks.append(TerminToken._new606(t, t, PersonAttrToken.M_TERMIN_VRIO))
                ...
                if (str0_.endswith("MAN") or str0_.endswith("PERSON") or str0_.endswith("MIST")): 
                    toks = list()
                    toks.append(TerminToken._new606(t, t, PersonAttrTermin._new2245(str0_, t.morph.language, PersonAttrTerminType.POSITION)))
                ...
                for tok in toks: 
                    ...
                    if (pat.typ == PersonAttrTerminType.PREFIX): 
                        if (step == 0 or ((pat.canonic_text != "ГРАЖДАНИН" and pat.canonic_text != "ГРОМАДЯНИН"))): 
                            return PersonAttrToken._new2304(tok.begin_token, tok.end_token, PersonAttrTerminType.PREFIX, pat.canonic_text, tok.morph, pat.gender)
                    if (pat.typ == PersonAttrTerminType.BESTREGARDS): 
                        end = tok.end_token
                        if (end.next0_ is not None and end.next0_.isCharOf(",")): 
                            end = end.next0_
                        return PersonAttrToken._new2296(tok.begin_token, end, PersonAttrTerminType.BESTREGARDS, MorphCollection._new2295(MorphCase.NOMINATIVE))
                        ...
                        if (res is not None): 
                            ...
                            if (npt0 is not None): 
                                ...
                                if (empty_adj is not None): 
                                    res1 = PersonAttrToken._new2307(res.begin_token, res.end_token, npt0.morph, res)
            ...
            if ((te is not None and te.previous.is_hiphen and not te.is_whitespace_after) and not te.is_whitespace_before): 
                if (BracketHelper.isBracket(te, False)): 
                    ...
                    if (br is not None and (isinstance(te, TextToken))): 
                        ppp = PersonAttrToken._new2289(t, br.end_token, br.end_token.previous.morph)
    ...
    def __getStdForms(tail : str, w1 : str, w2 : str) -> typing.List['MorphWordForm']:
        ...
        li1 = None
        li2 = None
        wrapli12311 = RefOutArgWrapper(None)
        inoutres2312 = Utils.tryGetValue(PersonAttrToken.M_STD_FORMS, w1, wrapli12311)
        ...
        for v in li1: 
            if (LanguageHelper.endsWith(v.normal_case, tail)): 
                res.append(v)
        if (w2 is not None): 
            wrapli22309 = RefOutArgWrapper(None)
            inoutres2310 = Utils.tryGetValue(PersonAttrToken.M_STD_FORMS, w2, wrapli22309)
    ...
    def __createAttrPosition(tok : 'TerminToken', loc_onto : 'IntOntologyCollection', attrs : 'PersonAttrAttachAttrs') -> 'PersonAttrToken':
        ...
        if (ty2 == PersonAttrTerminType2.ABBR): 
            ...
            return PersonAttrToken._new2313(tok.begin_token, tok.end_token, pr0, PersonAttrTerminType.POSITION)
        if (ty2 == PersonAttrTerminType2.IO or ty2 == PersonAttrTerminType2.IO2): 
            ...
            while True:
                ...
                if (tt is not None and tt.morph.class0_.is_preposition): 
                    tt = tt.next0_
                res_pat = PersonAttrToken._new2290(tok.begin_token, tok.end_token, PersonAttrTerminType.POSITION)
                ...
                wrapnam2315 = RefOutArgWrapper(nam)
                res_pat.begin_token = PersonAttrToken.__analizeVise(res_pat.begin_token, wrapnam2315)
        ...
        if (ty2 == PersonAttrTerminType2.GRADE): 
            ...
            if (tok.begin_token.isValue("КАНДИДАТ", None)): 
                ...
                if (tt is not None): 
                    ...
                    if (pat2 is not None): 
                        res0 = PersonAttrToken._new2290(tok.begin_token, pat2.end_token, PersonAttrTerminType.POSITION)
                        res0.prop_ref = PersonPropertyReferent._new2291("кандидат")
        ...
        t0 = tok.begin_token
        t1 = tok.end_token
        wrapname2327 = RefOutArgWrapper(name)
        t0 = PersonAttrToken.__analizeVise(t0, wrapname2327)
        ...
        while True:
                        ...
                        if (zap and not and0_): 
                            ...
                            if (PersonAttrToken.__isPerson(tt1.next0_)): 
                                ...
                                if (PersonAttrToken.__isPerson(tt1.next0_.next0_)): 
                                    ...
                                    wrapccc2318 = RefOutArgWrapper(None)
                                    ttt = PersonAttrToken.__tryAttachCategory(tt1.next0_.next0_, wrapccc2318)
            ...
            if ((te.chars.is_latin_letter and te.length_char > 1 and not t0.chars.is_latin_letter) and not te.chars.is_all_lower): 
                if (r is None or r.type_name != PersonAttrToken.OBJ_NAME_ORG): 
                    wrapcategory2319 = RefOutArgWrapper(None)
                    tt = PersonAttrToken.__tryAttachCategory(t, wrapcategory2319)
            ...
            if (r is not None): 
                ...
                break
            if (category is None): 
                wrapcategory2320 = RefOutArgWrapper(None)
                tt = PersonAttrToken.__tryAttachCategory(t, wrapcategory2320)
            ...
            if (not t.chars.is_all_lower): 
                if ("TestAttr" in t.kit.misc_data): 
                    ...
                    if (pits is not None and len(pits) > 1): 
                        ...
                        li = PersonIdentityToken.tryAttach(pits, 0, MorphBaseInfo._new2321(MorphCase.ALL_CASES), None, False, False)
                        del t.kit.misc_data["TestAttr"]
                        if (len(li) > 0 and li[0].coef > 1): 
                            t.kit.misc_data["TestAttr"] = None
                            li1 = PersonIdentityToken.tryAttach(pits, iii, MorphBaseInfo._new2321(MorphCase.ALL_CASES), None, False, False)
                            del t.kit.misc_data["TestAttr"]
                            if (len(li1) == 0): 
                                break
                            ...
                            t.kit.misc_data["TestAttr"] = None
                            li1 = PersonIdentityToken.tryAttach(pits, 1, MorphBaseInfo._new2321(MorphCase.ALL_CASES), None, False, False)
                            del t.kit.misc_data["TestAttr"]
        ...
        if (category is not None): 
            ...
            wrapcategory2324 = RefOutArgWrapper(None)
            tt = PersonAttrToken.__tryAttachCategory(t1.next0_, wrapcategory2324)
            category = wrapcategory2324.value
            if (tt is not None): 
                name = "{0} {1}".format(name, category)
                t1 = tt
        pr.name = name
        res = PersonAttrToken._new2325(t0, t1, PersonAttrTerminType.POSITION, pr, tok.morph)
        ...
        if (i >= 0): 
            i += 11
            res1 = PersonAttrToken._new2296(t0, t1, PersonAttrTerminType.POSITION, tok.morph)
            res1.prop_ref = PersonPropertyReferent()
    ...
    def __createAttrGrade(tok : 'TerminToken') -> 'PersonAttrToken':
        ...
        return PersonAttrToken._new2328(tok.begin_token, t1, PersonAttrTerminType.POSITION, pr, tok.morph, False)
    ...
    @staticmethod
    def _new2289(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'MorphCollection') -> 'PersonAttrToken':
        res = PersonAttrToken(_arg1, _arg2)
        res.morph = _arg3
        return res
    
    @staticmethod
    def _new2290(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PersonAttrTerminType') -> 'PersonAttrToken':
        res = PersonAttrToken(_arg1, _arg2)
        res.typ = _arg3
        return res
    
    @staticmethod
    def _new2294(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PersonAttrTerminType', _arg4 : str, _arg5 : 'MorphCollection') -> 'PersonAttrToken':
        res = PersonAttrToken(_arg1, _arg2)
        res.typ = _arg3
        res.age = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new2296(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PersonAttrTerminType', _arg4 : 'MorphCollection') -> 'PersonAttrToken':
        res = PersonAttrToken(_arg1, _arg2)
        res.typ = _arg3
        res.morph = _arg4
        return res
    ...
    @staticmethod
    def _new2298(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PersonAttrTerminType', _arg4 : str) -> 'PersonAttrToken':
        res = PersonAttrToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        return res
    ...
    @staticmethod
    def _new2304(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PersonAttrTerminType', _arg4 : str, _arg5 : 'MorphCollection', _arg6 : 'MorphGender') -> 'PersonAttrToken':
        res = PersonAttrToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new2307(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'MorphCollection', _arg4 : 'PersonAttrToken') -> 'PersonAttrToken':
        res = PersonAttrToken(_arg1, _arg2)
        res.morph = _arg3
    ...
    @staticmethod
    def _new2313(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PersonPropertyReferent', _arg4 : 'PersonAttrTerminType') -> 'PersonAttrToken':
        res = PersonAttrToken(_arg1, _arg2)
        res.prop_ref = _arg3
        res.typ = _arg4
        return res
    ...
    @staticmethod
    def _new2325(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PersonAttrTerminType', _arg4 : 'PersonPropertyReferent', _arg5 : 'MorphCollection') -> 'PersonAttrToken':
        res = PersonAttrToken(_arg1, _arg2)
        res.typ = _arg3
        res.prop_ref = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new2328(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'PersonAttrTerminType', _arg4 : 'PersonPropertyReferent', _arg5 : 'MorphCollection', _arg6 : bool) -> 'PersonAttrToken':
        res = PersonAttrToken(_arg1, _arg2)
        res.typ = _arg3
        res.prop_ref = _arg4
        res.morph = _arg5
