...
class DateExToken(MetaToken):
    ...
    class DateValues:
            ...
            if (list0_ is not None): 
                for v in list0_: 
                    if (v.typ != DateExToken.DateExItemTokenType.HOUR and v.typ != DateExToken.DateExItemTokenType.MINUTE): 
                        oo = True
            if (not oo): 
                return DateExToken.DateValues._new639(today.year, today.month, today.day)
        ...
        @staticmethod
        def _new639(_arg1 : int, _arg2 : int, _arg3 : int) -> 'DateValues':
            res = DateExToken.DateValues()
            res.year = _arg1
            res.month1 = _arg2
            res.day1 = _arg3
    ...
    class DateExItemToken(MetaToken):
        ...
        def tryParse(t : 'Token', prev : typing.List['DateExItemToken']) -> 'DateExItemToken':
            ...
            if (t.isValue("ЗАВТРА", None)): 
                return DateExToken.DateExItemToken._new642(t, t, DateExToken.DateExItemTokenType.DAY, 1, True)
            if (t.isValue("ПОСЛЕЗАВТРА", None)): 
                return DateExToken.DateExItemToken._new642(t, t, DateExToken.DateExItemTokenType.DAY, 2, True)
            if (t.isValue("ВЧЕРА", None)): 
                return DateExToken.DateExItemToken._new642(t, t, DateExToken.DateExItemTokenType.DAY, -1, True)
            if (t.isValue("ПОЗАВЧЕРА", None)): 
                return DateExToken.DateExItemToken._new642(t, t, DateExToken.DateExItemTokenType.DAY, -2, True)
            if (t.isValue("ПОЛЧАСА", None)): 
                return DateExToken.DateExItemToken._new642(t, t, DateExToken.DateExItemTokenType.MINUTE, 30, True)
            ...
            if (npt.noun.isValue("ГОД", None) or npt.noun.isValue("ГОДИК", None)): 
                ...
                return None
            res = DateExToken.DateExItemToken._new641(t, npt.end_token, ty, val)
            heg = False
        ...
        @staticmethod
        def _new641(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'DateExItemTokenType', _arg4 : int) -> 'DateExItemToken':
        ...
        @staticmethod
        def _new642(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'DateExItemTokenType', _arg4 : int, _arg5 : bool) -> 'DateExItemToken':
            res = DateExToken.DateExItemToken(_arg1, _arg2)
            res.typ = _arg3
            res.value = _arg4
    ...
    def tryParse(t : 'Token') -> 'DateExToken':
        ...
        while True:
            ...
            if (drr is not None): 
                res = DateExToken._new640(t, tt, True)
                fr = drr.date_from
                if (fr is not None): 
    ...
    def __addItems(fr : 'DateReferent', res : typing.List['DateExItemToken'], tt : 'Token') -> None:
        if (fr.year > 0): 
            res.append(DateExToken.DateExItemToken._new641(tt, tt, DateExToken.DateExItemTokenType.YEAR, fr.year))
        elif (fr.pointer == DatePointerType.TODAY): 
            res.append(DateExToken.DateExItemToken._new642(tt, tt, DateExToken.DateExItemTokenType.YEAR, 0, True))
        if (fr.month > 0): 
            res.append(DateExToken.DateExItemToken._new641(tt, tt, DateExToken.DateExItemTokenType.MONTH, fr.month))
        elif (fr.pointer == DatePointerType.TODAY): 
            res.append(DateExToken.DateExItemToken._new642(tt, tt, DateExToken.DateExItemTokenType.MONTH, 0, True))
        if (fr.day > 0): 
            res.append(DateExToken.DateExItemToken._new641(tt, tt, DateExToken.DateExItemTokenType.DAY, fr.day))
        elif (fr.pointer == DatePointerType.TODAY): 
            res.append(DateExToken.DateExItemToken._new642(tt, tt, DateExToken.DateExItemTokenType.DAY, 0, True))
    
    @staticmethod
    def _new640(_arg1 : 'Token', _arg2 : 'Token', _arg3 : bool) -> 'DateExToken':
