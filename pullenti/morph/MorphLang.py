...
class MorphLang:
    ...
    @staticmethod
    def _new76(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_ru = _arg1
        return res
    ...
    def _static_ctor():
        ...
        MorphLang.RU = MorphLang._new76(True)
        MorphLang.UA = MorphLang._new77(True)
        MorphLang.BY = MorphLang._new78(True)
        MorphLang.EN = MorphLang._new79(True)
        MorphLang.IT = MorphLang._new80(True)
        MorphLang.KZ = MorphLang._new81(True)
